...
struct Globals
{
	...
	LIBZHL_API static Point *__stdcall LineRectCollide(Point *__return_storage_ptr__, Globals::Rect *rect, Point p1, Point p2);
...
struct LIBZHL_INTERFACE ArmamentControl
{
	...
	LIBZHL_API virtual void RenderTouchTooltips();
...
struct LIBZHL_INTERFACE ShipSystem
{
	...
	LIBZHL_API void CheckForRepower1();
	...
	LIBZHL_API void SetFloorImage1(const std::string &name);
	...
	LIBZHL_API void StartingPowerUp1();
...
struct LIBZHL_INTERFACE Projectile : Collideable
{
	...
	LIBZHL_API void constructor(Projectile *param_1);
...
struct CSurface
{
	...
	*/
	...
	LIBZHL_API static GL_Primitive *__stdcall GL_CreateCirclePrimitive(int x, int y, float radius, GL_Color color);
	...
	LIBZHL_API static GL_Primitive *__stdcall GL_CreateMultiTrianglePrimitive(std::vector<Pointf> *points, GL_Color color);
	...
	LIBZHL_API static GL_Primitive *__stdcall GL_CreateTrianglePrimitive(Point p1, Point p2, Point p3, GL_Color color);
	...
	LIBZHL_API static bool __stdcall GL_DrawPiePartial(int x, int y, float radius, float deg1, float deg2, float thickness, GL_Color color);
...
public:
	...
	LIBZHL_API __int64 GetSize_orig();
...
struct DroneControl : ArmamentControl
{
	...
	LIBZHL_API void SelectArmament1(unsigned int i);
...
struct WeaponControl : ArmamentControl
{
	...
	LIBZHL_API int NumArmamentSlots();
	LIBZHL_API void OnLanguageChange();
	LIBZHL_API void OnLanguageChange1();
	LIBZHL_API void OnLoop();
...
struct CombatControl
{
	...
	LIBZHL_API void OnRenderTooltips();
	LIBZHL_API bool OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY);
...
struct SystemControl
{
	...
	LIBZHL_API static SystemControl::PowerBars *__stdcall GetPowerBars1(int width, int height, int gap, bool useShieldGap);
...
struct CommandGui
{
	...
	LIBZHL_API void CheckGameover1();
	LIBZHL_API void ClearLocation();
	...
	LIBZHL_API void MouseMove(int mX, int mY);
	LIBZHL_API void MouseMove1(int mX, int mY);
...
struct CrewBox
{
	...
	LIBZHL_API Point GetBottomRight();
...
struct DebugHelper
{
	...
	LIBZHL_API std::string LookupAdress(unsigned long address);
	LIBZHL_API void ParseFile();
...
struct ShipGraph
{
	...
	{
        __int64 ret = ConvertToWorldPosition_orig(local);
        return *((Pointf*) &ret);
	}

	Pointf ConvertToLocalPosition(Pointf world, bool past)
	{
        __int64 ret = ConvertToLocalPosition_orig(world, past);
        return *((Pointf*) &ret);
	}

    Point GetSlotRenderPosition(int slotId, int roomId, bool intruder)
    {
        __int64 ret = GetSlotRenderPosition_orig(slotId, roomId, intruder);
        return *((Point*) &ret);
    }
	...
	LIBZHL_API __int64 ConvertToLocalPosition_orig(Pointf world, bool past);
	LIBZHL_API float ConvertToWorldAngle(float ang);
	LIBZHL_API __int64 ConvertToWorldPosition_orig(Pointf local);
	...
	LIBZHL_API __int64 GetSlotRenderPosition_orig(int slotId, int roomId, bool intruder);
...
struct DroneSystem : ShipSystem
{
	...
	LIBZHL_API bool PowerDrone1(Drone *drone, bool userDriven, bool force);
...
struct ExplosionAnimation : AnimationTracker
{
	...
	LIBZHL_API void OnRender1(Globals::Rect *shipRect, ImageDesc shipImage, GL_Primitive *shipImagePrimitive);
	LIBZHL_API void Restart();
...
struct TopScore
{
	...
	LIBZHL_API void constructor(const TopScore &other);
...
{
	LIBZHL_API bool AddAugmentation(const std::string &augment);
	LIBZHL_API bool AddAugmentation1(const std::string &augId);
	LIBZHL_API void AddEquipment(const std::string &blueName);
	LIBZHL_API void Clear();
	LIBZHL_API int GetAugmentationCount();
	LIBZHL_API std::vector<std::string> GetAugmentationList();
...
struct SoundControl
{
	LIBZHL_API bool AddChannelToMixer(int track);
	...
	LIBZHL_API void PauseLoops1(bool gamePaused);
	...
	LIBZHL_API void StopPlaylist1(int fadeout);
...
struct WeaponBox : ArmamentBox
{
	...
	LIBZHL_API void RenderBox1(bool dragging, bool flashPowerBox);
