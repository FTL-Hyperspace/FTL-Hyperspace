...
struct freetype
{
	...
	static Pointf freetype::easy_print(int fontSize, float x, float y, const std::string& text)
	{
        uint64_t ret = freetype::easy_print_DO_NOT_USE_DIRECTLY(fontSize, x, y, text);
        return *((Pointf*) &ret);
	}
	
    static Pointf freetype::easy_printRightAlign(int fontSize, float x, float y, const std::string& text)
    {
        uint64_t ret = freetype::easy_printRightAlign_DO_NOT_USE_DIRECTLY(fontSize, x, y, text);
        return *((Pointf*) &ret);
    }
    
    static Pointf freetype::easy_printNewlinesCentered(int fontSize, float x, float y, int line_length, const std::string& text)
    {
        uint64_t ret = freetype::easy_printNewlinesCentered_DO_NOT_USE_DIRECTLY(fontSize, x, y, line_length, text);
        return *((Pointf*) &ret);
    }
    
    static Pointf freetype::easy_printAutoNewlines(int fontSize, float x, float y, int line_length, const std::string& text)
    {
        uint64_t ret = freetype::easy_printAutoNewlines_DO_NOT_USE_DIRECTLY(fontSize, x, y, line_length, text);
        return *((Pointf*) &ret);
    }
    
    static Pointf freetype::easy_printCenter(int fontSize, float x, float y, const std::string& text)
    {
