...
{
    static void *func = 0;
	static FunctionDefinition funcObj("AsteroidGenerator::UpdateState", typeid(void (AsteroidGenerator::*)()), ".554889e5535048", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("AugmentStoreBox::CanHold", typeid(bool (AugmentStoreBox::*)()), ".554889e54157", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("AugmentStoreBox::MouseMove", typeid(void (AugmentStoreBox::*)(int , int )), ".554889e541574156534883ec68", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("AugmentStoreBox::Purchase", typeid(void (AugmentStoreBox::*)()), ".554889e54156534883ec204889fbe82d", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BlueprintManager::SetRarity", typeid(void (BlueprintManager::*)(const std::string &, int )), ".554889e54157415641554154534883", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Button::constructor", typeid(void (Button::*)()), ".554889e54156534889fb488d05????28", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CSurface::GL_DrawLaser", typeid(bool (*)(int , int , int , int , GL_Color )), ".554889e54157415641554154534883ec7866", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CSurface::GL_CreateImagePartialPrimitive", typeid(GL_Primitive *(*)(GL_Texture *, float , float , float , float , float , float , float , float , float , GL_Color , bool )), "!.554889e54156534883ec60f30f117dd0", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ChoiceBox::KeyDown", typeid(bool (ChoiceBox::*)(SDLKey )), "554889e5488d05????29", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ChoiceBox::PrintResourceBox", typeid(ResourceBoxDesc (ChoiceBox::*)(ResourceEvent *, int , int , GL_Color , bool )), ".554889e54157415641554154534881ece804", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewCustomizeBox::SetCustomizeMode", typeid(void (CrewCustomizeBox::*)(Point )), ".554889e54157415641554154534883ec584989f7", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewCustomizeBox::CheckContents", typeid(void (CrewCustomizeBox::*)()), ".55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Door::constructor", typeid(void (Door::*)()), ".554889e54157415641554154534881ec7801000045", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Door::LoadState", typeid(void (Door::*)(int )), "!.554889e54156534189f64889fb44", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Door::DO_NOT_HOOK", typeid(void (Door::*)()), "!.554889e553", nullptr, 0, 0, &func);
}

namespace _func575
{
    static void *func = 0;
	static FunctionDefinition funcObj("Door::destructor", typeid(void (Door::*)()), "!.554889e553", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Door::ConnectsRooms", typeid(bool (Door::*)(int , int )), ".554889e583", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("DropBox::OnInit", typeid(void (DropBox::*)(Point , bool , TextString *, TextString *, int , TextString *)), "554889e54157415641554154534883ec6844", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Equipment::constructor", typeid(void (Equipment::*)()), "!.554889e553504889fbe842bf", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Equipment::Jump", typeid(void (Equipment::*)()), ".55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Equipment::Close", typeid(void (Equipment::*)()), "!.554889e55de97671", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("EventsParser::ProcessChoice", typeid(void (EventsParser::*)(EventTemplate *, rapidxml::xml_node<char> *, std::string &)), ".554889e54157415641554154534881ec38", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("FocusWindow::constructor", typeid(void (FocusWindow::*)()), "!.554889e553504889fb488d0508", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("InputBox::OnRender", typeid(void (InputBox::*)()), ".554889e553", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("MindSystem::ReleaseCrew", typeid(void (MindSystem::*)()), ".554889e54157415641554154534883ec184989fc498b9424", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("PowerManager::SetHacked", typeid(void (PowerManager::*)(bool )), ".554889e540", nullptr, 0, 0, &func);
}
...
namespace _var877
{
    static VariableDefinition varObj("Global_ResourceControl_GlobalResources", "!004889fb488d3d(???????\?)", &Global_ResourceControl_GlobalResources, true, true);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::CreateArmory", typeid(void (ShipManager::*)()), ".55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::RemoveCrewmember", typeid(void (ShipManager::*)(CrewMember *)), "!.55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::IsCrewOverFull", typeid(bool (ShipManager::*)()), ".554889e553504889fb31f6837b0800400f95c6488d", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::IsCrewFull", typeid(bool (ShipManager::*)()), ".554889e553504889fb31f6837b0800400f95c6488d", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::CloneHealing", typeid(void (ShipManager::*)()), ".554889e54157415653", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::CheckDlcEnabled", typeid(void (ShipManager::*)()), ".55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::SetSystemPowerLimit", typeid(void (ShipManager::*)(int , int )), "!.554889e5535089d3", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::GetSystemHealth", typeid(int (ShipManager::*)(int )), ".554889e54863c6488b8fd806000048", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::CreateDrone", typeid(Drone *(ShipManager::*)(DroneBlueprint *)), ".55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipSystem::SetDividePower", typeid(void (ShipSystem::*)(int )), "!.554889e553504889fb89b3a8", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipSystem::IonDamage", typeid(void (ShipSystem::*)(int )), ".554889e54156534189f64889fb45", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("StarMap::MapConnected", typeid(bool (StarMap::*)()), ".554889e54156534889fb488dbbb80c00", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemControl::RenderPowerBar", typeid(void (SystemControl::*)()), "!.55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("TabbedWindow::SetTab", typeid(void (TabbedWindow::*)(unsigned int )), ".554889e54157415641554154534883ec784189f6", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("TabbedWindow::Close", typeid(void (TabbedWindow::*)()), "!.55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("WeaponEquipBox::constructor", typeid(void (WeaponEquipBox::*)(Point , WeaponSystem *, int )), "554889e54156534883ec204989d6", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("WeaponStoreBox::Purchase", typeid(void (WeaponStoreBox::*)()), "!.554889e553504889fbe862d1", nullptr, 0, 0, &func);
}
