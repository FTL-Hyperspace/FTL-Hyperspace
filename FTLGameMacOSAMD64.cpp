...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ChoiceBox::KeyDown", typeid(bool (ChoiceBox::*)(SDLKey )), "554889e5488d0535", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Door::destructor", typeid(void (Door::*)()), "!.554889e553504889fb488d05b0", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Equipment::destructor", typeid(void (Equipment::*)()), ".554889e553504889fb488d0560????004883", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("EquipmentBox::ForceHitBox", typeid(void (EquipmentBox::*)(Globals::Rect *)), ".55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("EquipmentBox::RenderIcon", typeid(void (EquipmentBox::*)()), ".55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("EquipmentBox::GetType", typeid(int (EquipmentBox::*)(bool )), ".554889e5488b8f800000004885c9750a", nullptr, 0, 0, &func);
}
