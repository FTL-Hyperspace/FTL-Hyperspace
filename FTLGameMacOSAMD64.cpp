...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::destructor", typeid(void (Animation::*)()), "!554889e5415741564155415453504889fbf683b800000001", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::SetProgress", typeid(void (Animation::*)(float )), ".554889e5f30f594708f30f1147105dc3", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::SetCurrentFrame", typeid(void (Animation::*)(int )), ".554889e58b47088d48ff", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::Done", typeid(bool (Animation::*)()), ".554889e5807f3e00740f0f57c0", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::Update", typeid(void (Animation::*)()), ".554889e54157415641554154534883ec184989fd418b5d08f30f2ac3ffcb", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AsteroidGenerator::SaveAsteroids", typeid(void (AsteroidGenerator::*)(int )), "!.554889e54156534189f64889fbf30f1083880000", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AsteroidGenerator::LoadAsteroids", typeid(void (AsteroidGenerator::*)(int )), ".554889e541565389f34989fe89dfe8????1300f3", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AugmentStoreBox::DO_NOT_HOOK_FALSE_CONSTRUCTOR", typeid(void (AugmentStoreBox::*)()), "!.554889e54156534883ec204989d64889f04889fb", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("BossShip::SaveBoss", typeid(void (BossShip::*)(int )), "!.554889e54157415653504189f64989ff", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("BossShip::LoadBoss", typeid(void (BossShip::*)(int )), "!.554889e54157415641554154534883ec284189f5", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Button::DO_NOT_HOOK_FALSE_CONSTRUCTOR", typeid(void (Button::*)()), ".554889e54156534889fb488d05????????488903488d7b08", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("CachedImage::DO_NOT_HOOK_FALSE_CONSTRUCTOR_1", typeid(void (CachedImage::*)()), "!.554889e54157415653504189ce4189d74889fb48c7430800000000", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("CachedImage::DO_NOT_HOOK_FALSE_CONSTRUCTOR_2", typeid(void (CachedImage::*)()), "!.554889e553504889fb48c74308????????488d05", nullptr, 0, 0, &func);
}

namespace _func209
{
	static void *func = 0;
	static FunctionDefinition funcObj("CachedImage::constructor2", typeid(void (CachedImage::*)(const std::string &)), "!.554889e553504889fb48c74308????????488d05", nullptr, 0, 0, &func);
}

void CachedImage::constructor2(const std::string &path)
{
	typedef void (*custom_arg_funcptr_t)(CachedImage *this_arg, const std::string &path_arg);
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("CachedImage::DO_NOT_HOOK_FALSE_CONSTRUCTOR_3", typeid(void (CachedImage::*)()), "!.554889e54156534989f64889fb48c74308", nullptr, 0, 0, &func);
}

namespace _func211
{
	static void *func = 0;
	static FunctionDefinition funcObj("CachedImage::constructor_copy", typeid(void (CachedImage::*)(const CachedImage &)), "!.554889e54156534989f64889fb48c74308", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("CachedImage::SetImagePath", typeid(void (CachedImage::*)(const std::string &)), ".554889e54156534889fb488d3d????????e8????????4989c6", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("CompleteShip::DO_NOT_HOOK_FALSE_CONSTRUCTOR", typeid(void (CompleteShip::*)()), "!554889e553504889fb488d05????????488903894b08", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("CompleteShip::OnInit", typeid(void (CompleteShip::*)(const ShipBlueprint *, int )), "!.554889e5415741564154534189d64989f74889fb", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("CompleteShip::AddDrone", typeid(Drone *(CompleteShip::*)(const DroneBlueprint *, int )), "!.554889e5488b7f105de9????0700", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("CompleteShip::KillRandomCrew", typeid(void (CompleteShip::*)()), "!.554889e5488b7f105de9????0800", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("CompleteShip::CountCrew", typeid(int (CompleteShip::*)(bool )), "!.554889e5488b7f10400fb6f65de9", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("ConfirmWindow::DO_NOT_HOOK_FALSE_CONSTRUCTOR", typeid(void (ConfirmWindow::*)()), "!.554889e553504889fbe8????????488d05????????48890348c7432000000000", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("ConfirmWindow::OnRender", typeid(void (ConfirmWindow::*)()), ".554889e54157415641554154534883ec784989fd", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("CreditScreen::DO_NOT_HOOK_FALSE_CONSTRUCTOR", typeid(void (CreditScreen::*)()), "554889e5c7473800000000", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("CrewAnimation::SetupStrips", typeid(void (CrewAnimation::*)()), "!.554889e54157415641554154534881ecd80100004989fd498d9d100a0000", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("CrewManifest::constructor", typeid(void (CrewManifest::*)()), "!554889e5415741564154534881ec????????4889fbe8", nullptr, 0, 0, &func);
}
...
void DamageMessage::constructor2(float _length, int _amount, Pointf _pos, bool _symbol)
{
	typedef void (*custom_arg_funcptr_t)(DamageMessage *this_arg, float _length_arg, int _amount_arg, Pointf _pos_arg, bool _symbol_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func535::func;
	return execfunc(this, _length, _amount, _pos, _symbol);
}
...
void DamageMessage::constructor(float _length, Pointf _pos, DamageMessage::MessageType _type)
{
	typedef void (*custom_arg_funcptr_t)(DamageMessage *this_arg, float _length_arg, Pointf _pos_arg, DamageMessage::MessageType _type_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func536::func;
	return execfunc(this, _length, _pos, _type);
}
...
void DoorBox::constructor(Point _pos, ShipSystem *_sys, ShipManager *_ship)
{
	typedef void (*custom_arg_funcptr_t)(DoorBox *this_arg, Point _pos_arg, ShipSystem *_sys_arg, ShipManager *_ship_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func548::func;
	return execfunc(this, _pos, _sys, _ship);
}
...
void DroneStoreBox::constructor(ShipManager *_ship, Equipment *_equip, const DroneBlueprint *_bp)
{
	typedef void (*custom_arg_funcptr_t)(DroneStoreBox *this_arg, ShipManager *_ship_arg, Equipment *_equip_arg, const DroneBlueprint *_bp_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func554::func;
	return execfunc(this, _ship, _equip, _bp);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("InfoBox::constructor", typeid(void (InfoBox::*)()), "554889e553504889fb31f631d2e8ae750700", nullptr, 0, 0, &func);
}
...
void PDSFire::constructor(Point _pos, int _destinationSpace, Pointf _destination)
{
	typedef void (*custom_arg_funcptr_t)(PDSFire *this_arg, Point _pos_arg, int _destinationSpace_arg, Pointf _destination_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func750::func;
	return execfunc(this, _pos, _destinationSpace, _destination);
}
...
void ProjectileFactory::DO_NOT_HOOK_FALSE_DESTRUCTOR()
{
	typedef void (*custom_arg_funcptr_t)(ProjectileFactory *this_arg);
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("ShipSystem::PartialDamage", typeid(bool (ShipSystem::*)(float )), "!.554889e5", nullptr, 0, 32, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("SpaceManager::GetScreenShake", typeid(int (SpaceManager::*)()), ".554889e58a87a0040000c687a0040000005dc3", nullptr, 0, 32, &func);
}
...
void StarMap::GetSelectedSector(int mouseX, int mouseY, int maxDist)
{
	typedef void (*custom_arg_funcptr_t)(StarMap *this_arg, int mouseX_arg, int mouseY_arg, int maxDist_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func1186::func;
	return execfunc(this, mouseX, mouseY, maxDist);
}
...
{
	typedef void (*custom_arg_funcptr_t)(StarMap *this_arg, SDLKey sym_arg);
...
void StarMap::MouseClick(int mouseX, int mouseY)
{
	typedef void (*custom_arg_funcptr_t)(StarMap *this_arg, int mouseX_arg, int mouseY_arg);
...
void StarMap::MouseMove(int mouseX, int mouseY)
{
	typedef void (*custom_arg_funcptr_t)(StarMap *this_arg, int mouseX_arg, int mouseY_arg);
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("TextButton::destructor", typeid(void (TextButton::*)()), "1.554889e553504889fb488d05????????488903488b7b50", nullptr, 0, 0, &func);
}
...
void UnlockArrow::constructor(Point pos, int status, int dir)
{
	typedef void (*custom_arg_funcptr_t)(UnlockArrow *this_arg, Point pos_arg, int status_arg, int dir_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func1351::func;
	return execfunc(this, pos, status, dir);
}
...
void WarningMessage::DO_NOT_HOOK_FALSE_CONSTRUCTOR()
{
...
void WeaponStoreBox::constructor(ShipManager *_ship, Equipment *_equip, const WeaponBlueprint *_weaponBp)
{
	typedef void (*custom_arg_funcptr_t)(WeaponStoreBox *this_arg, ShipManager *_ship_arg, Equipment *_equip_arg, const WeaponBlueprint *_weaponBp_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func1410::func;
	return execfunc(this, _ship, _equip, _weaponBp);
}
