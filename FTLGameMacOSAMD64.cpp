...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::LoadAchievementDescriptions", typeid(void (AchievementTracker::*)()), ".554889e54157415641554154534881ec780201004989fe", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::LoadProfile", typeid(void (AchievementTracker::*)(int , int )), ".554889e54157415641554154534883ec688955c448897dc88975d4", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::DO_NOT_HOOK_1", typeid(bool (AchievementTracker::*)()), ".554889e541574156415541545350", nullptr, 0, 0, &func);
}

namespace _func8
{
	static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::GetFlag", typeid(bool (AchievementTracker::*)(const std::string &)), ".554889e541574156415541545350", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::GetShipMarker", typeid(int (AchievementTracker::*)(const std::string &, const std::string &)), ".554889e54157415641554154534883ec", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::CheckShipAchievements", typeid(void (AchievementTracker::*)(int , bool )), ".554889e54157415641554154534883ec", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::SetTooltip", typeid(void (AchievementTracker::*)(CAchievement *)), ".554889e54157415641554154534881ec", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::SetVictoryAchievement", typeid(void (AchievementTracker::*)()), ".554889e54157415641554154534883ec384989fe4d8dbe", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::UnlockShip", typeid(void (AchievementTracker::*)(int , int )), ".554889e54157415641554154534883ec184989fd83fa02", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::ResetFlags", typeid(void (AchievementTracker::*)()), ".554889e54156534889fb488d7b484c8d7350", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::SetFlag", typeid(void (AchievementTracker::*)(const std::string &)), ".554889e54157415641554154534883ec184989f54989fe498d5e484889df", nullptr, 0, 0, &func);
}
...
namespace _var16
{
	static VariableDefinition varObj("Global_AchievementTracker_Tracker", ".410fb6b6e802000089dfe8????1200488d3d(???????\?)89de", &Global_AchievementTracker_Tracker, true, true);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::SaveState", typeid(void (Animation::*)(int )), ".554889e54156534189f64889fb0fb6", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::LoadState", typeid(void (Animation::*)(int )), ".554889e54156534189f64889fb4489f7e81bf8000085c0", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::Start", typeid(void (Animation::*)(bool )), ".554889e553504889fb0f57c04084f67505f30f104338", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::SetProgress", typeid(void (Animation::*)(float )), ".554889e5f30f105730f30f59c2f30f1147388b4708f30f2ac8ffc8", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::SetCurrentFrame", typeid(void (Animation::*)(int )), ".554889e58b47088d48ff39f10f4ef131c985f60f49ce", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::Done", typeid(bool (Animation::*)()), ".554889e5807f3e00740f0f57c00f2e87b00000000f93c0", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::RandomStart", typeid(int (Animation::*)()), ".554889e553504889fb488d05??????008038", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::SetAnimationId", typeid(void (Animation::*)(GL_Texture *)), ".554889e548393774394889374889f0", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::AddSoundQueue", typeid(void (Animation::*)(int , const std::string &)), ".85f6784f488b8798000000488b8fa0000000", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("Animation::StartReverse", typeid(void (Animation::*)(bool )), ".554889e553504889fb4084f67422c6433e0066c7433c0101", nullptr, 0, 0, &func);
}
