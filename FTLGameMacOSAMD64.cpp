...
{
    static void *func = 0;
	static FunctionDefinition funcObj("AsteroidGenerator::Initialize", typeid(float (AsteroidGenerator::*)(int , int , bool )), ".554889e553", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CSurface::GL_BlitPixelImage", typeid(bool (*)(GL_Texture *, float , float , float , float , float , GL_Color , bool )), "!.554889e5????????????????????????????????????????????????????00", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CSurface::GL_BlitImagePartial", typeid(bool (*)(GL_Texture *, float , float , float , float , float , float , float , float , float , GL_Color , bool )), ".0f1f??0000", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ControlsScreen::OnRender", typeid(void (ControlsScreen::*)()), ".554889e5415741564155415453", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Door::DO_NOT_HOOK_1", typeid(void (Door::*)()), "!.554889e553500f2805e3", nullptr, 0, 0, &func);
}

namespace _func595
{
    static void *func = 0;
	static FunctionDefinition funcObj("Door::constructor", typeid(void (Door::*)()), ".554889e541", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("EquipmentBox::InitPrimitives", typeid(void (EquipmentBox::*)()), "554889e5534883ec184889fb48c7", nullptr, 0, 0, &func);
}
...
namespace _var751
{
    static VariableDefinition varObj("Global_Globals_Library", "!410000488d1d(???????\?)", &Global_Globals_Library, true, true);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("RockAnimation::constructor", typeid(void (RockAnimation::*)(const std::string &, int , Pointf , bool )), "554889e54157415641554154534883ec", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipGraph::ComputeCenter", typeid(void (ShipGraph::*)()), "!.55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::DamageArea", typeid(bool (ShipManager::*)(Pointf , Damage , bool )), ".554889e54157415641", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::ClearStatusSystem", typeid(void (ShipManager::*)(int )), "!.83", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipSelect::OnTouch", typeid(void (ShipSelect::*)(TouchAction , int , int , int , int , int )), "!.55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SpaceManager::LoadSpace", typeid(void (SpaceManager::*)(int )), "!.55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SpaceManager::SetFireLevel", typeid(void (SpaceManager::*)(bool )), "!.55488", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SpaceManager::SwitchImages", typeid(void (SpaceManager::*)(ImageDesc , ImageDesc , ImageDesc )), "!.55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("StarMap::AddSectorColumn", typeid(void (StarMap::*)()), "!.55", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("StatusEffect::DO_NOT_HOOK_GetStormEffect", typeid(void (StatusEffect::*)()), "554889e58a05????190084c0", nullptr, 0, 0, &func);
}

namespace _func1412
{
    static void *func = 0;
	static FunctionDefinition funcObj("StatusEffect::GetNebulaEffect", typeid(StatusEffect (*)()), ".554889e58a05????190084c0", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("TextButton::constructor", typeid(void (TextButton::*)()), "554889e54156534889fb488d05??????00488903488d7b08e8????0a", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("WeaponControl::SetAutofiring", typeid(void (WeaponControl::*)(bool , bool )), ".5548", nullptr, 0, 0, &func);
}
