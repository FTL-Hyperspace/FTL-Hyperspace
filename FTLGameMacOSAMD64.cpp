...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Door::SaveState", typeid(void (Door::*)(int )), "!.554889e54156534189f64889fb8bb32c", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipSystem::RawDecreasePower", typeid(bool (ShipSystem::*)()), "eeeeee", nullptr, 0, 0, &func);
}
