...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BoarderDrone::GetPowered", typeid(bool (BoarderDrone::*)()), "0fb64710c3", nullptr, 0, 0, &func);
}

bool BoarderDrone::GetPowered()
{
	typedef bool (*custom_arg_funcptr_t)(BoarderDrone *this_arg);
