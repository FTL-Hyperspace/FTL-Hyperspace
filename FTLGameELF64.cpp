...
{
	static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::SetTarget", typeid(void (ShipManager::*)(ShipManager *)), ".41574156415541544989f455534889fb4883ec58", nullptr, 0, 0, &func);
}

void ShipManager::SetTarget(ShipManager *target)
{
	typedef void (*custom_arg_funcptr_t)(ShipManager *this_arg, ShipManager *target_arg);
