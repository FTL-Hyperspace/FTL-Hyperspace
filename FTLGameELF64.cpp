...
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::KeyDown", typeid(void (OptionsScreen::*)(SDLKey )), ".41574156415541544189f4554889fd53", nullptr, 0, 0, &func);
}

void OptionsScreen::KeyDown(SDLKey sym)
{
	typedef void (*custom_arg_funcptr_t)(OptionsScreen *this_arg, SDLKey sym_arg);
