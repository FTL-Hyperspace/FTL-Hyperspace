...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AsteroidGenerator::SaveAsteroids", typeid(void (AsteroidGenerator::*)(int )), ".554889fd5389f34883ec08", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("AsteroidGenerator::LoadAsteroids", typeid(void (AsteroidGenerator::*)(int )), ".5589f5534889fb89f74883ec08", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("SpaceDrone::destructor", typeid(void (SpaceDrone::*)()), "4157415641554154554889fd488dbf80", nullptr, 0, 0, &func);
}
...
{
	static void *func = 0;
	static FunctionDefinition funcObj("StarMap::KeyDown", typeid(void (StarMap::*)(SDLKey )), ".80bfb808000000", nullptr, 0, 0, &func);
}
