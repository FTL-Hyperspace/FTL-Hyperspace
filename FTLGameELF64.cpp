...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipSystem::CheckDlcEnabled", typeid(void (ShipSystem::*)()), "@ _ZN10ShipSystem15CheckDlcEnabledEv ", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipSystem::GetMannedDescription", typeid(std::string (*)(int , int )), "## ShipSystem::GetMannedDescription ->", nullptr, 0, 0, &func);
}

std::string ShipSystem::GetMannedDescription(int skillId, int level)
{
	typedef std::string (*custom_arg_funcptr_t)(int skillId_arg, int level_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipSystem::GetGlowInfoForImage", typeid(ShipSystem::ConstComputerGlowInfo *(*)(const std::string &)), "++ ShipSystem::GetGlowInfoForImage(std:: string&) ->", nullptr, 0, 0, &func);
}

ShipSystem::ConstComputerGlowInfo *ShipSystem::GetGlowInfoForImage(const std::string &image)
{
	typedef ShipSystem::ConstComputerGlowInfo *(*custom_arg_funcptr_t)(const std::string &image_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipSystem::GetExploded", typeid(bool (ShipSystem::*)()), "++ ShipSystem::GetExploded ", nullptr, 0, 0, &func);
}
...
namespace _var1268
{
    static VariableDefinition varObj("symbol_lookup_test_002", "@ adapdadcmapmopqpmcqcoqemcsdpqowkpqooqpqw || !488b3d(???????\?)", &symbol_lookup_test_002);
}
