...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ArmamentBox::OnRender", typeid(bool (ArmamentBox::*)(bool , bool )), "!41544189d45589f5534889fb4883ec10", nullptr, 0, 0, &func);
}

bool ArmamentBox::OnRender(bool dragging, bool flashPowerBox)
{
	typedef bool (*custom_arg_funcptr_t)(ArmamentBox *this_arg, bool dragging_arg, bool flashPowerBox_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ArmamentBox::OnTouch", typeid(bool (ArmamentBox::*)(TouchAction , int , int , int , int , int )), "!.41574989ff415641554589c541544189cc5589d55389f3", nullptr, 0, 0, &func);
}

bool ArmamentBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool (*custom_arg_funcptr_t)(ArmamentBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ArmamentControl::OnTouch", typeid(bool (ArmamentControl::*)(TouchAction , int , int , int , int , int )), "!.415741564155415455534889fb4883ec58488b7f184885ff", nullptr, 0, 0, &func);
}

bool ArmamentControl::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool (*custom_arg_funcptr_t)(ArmamentControl *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ArmamentControl::RenderDragging", typeid(void (ArmamentControl::*)()), "!.534889fb4883ec1080bf????????00747de8????????f30f2a4338", nullptr, 0, 0, &func);
}

void ArmamentControl::RenderDragging()
{
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ArmamentControl::RenderLabels", typeid(void (ArmamentControl::*)()), "!.4155415455534889fb4883ec088b7708", nullptr, 0, 0, &func);
}

void ArmamentControl::RenderLabels()
{
	typedef void (*custom_arg_funcptr_t)(ArmamentControl *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ArmamentControl::OnRender", typeid(void (ArmamentControl::*)(bool )), ".415541545589f5534889fb4883ec588b7708488b7f18", nullptr, 0, 0, &func);
}

void ArmamentControl::OnRender(bool front)
{
	typedef void (*custom_arg_funcptr_t)(ArmamentControl *this_arg, bool front_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ArmamentControl::destructor", typeid(void (ArmamentControl::*)()), ".41574156415541544989fc55534883ec58488b7728488b5720", nullptr, 0, 0, &func);
}

void ArmamentControl::destructor()
{
	typedef void (*custom_arg_funcptr_t)(ArmamentControl *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ArmamentControl::constructor", typeid(void (ArmamentControl::*)(int )), ".53baffffffff4889fb897708", nullptr, 0, 0, &func);
}

void ArmamentControl::constructor(int systemId)
{
	typedef void (*custom_arg_funcptr_t)(ArmamentControl *this_arg, int systemId_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BatteryBox::OnRender", typeid(void (BatteryBox::*)(bool )), "!.4154400fb6f655534889fbe8????0300448ba3700300008bab74030000", nullptr, 0, 0, &func);
}

void BatteryBox::OnRender(bool ignoreStatus)
{
	typedef void (*custom_arg_funcptr_t)(BatteryBox *this_arg, bool ignoreStatus_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BatteryBox::OnTouch", typeid(void (BatteryBox::*)(TouchAction , int , int , int , int , int )), "!.41574589cf415641554589c541544189cc5589d5534889fb488dbfe00200004883ec18", nullptr, 0, 0, &func);
}

void BatteryBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(BatteryBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CApp::OnTouchDown", typeid(void (CApp::*)(int , int , int )), "f3c36666", nullptr, 0, 32, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CApp::OnTouchMove", typeid(void (CApp::*)(int , int , int , int , int )), ".f3c36666", nullptr, 0, 32, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CApp::OnTouchUp", typeid(void (CApp::*)(int , int , int , int , int )), ".f3c36666", nullptr, 0, 32, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CApp::OnTouchCancel", typeid(void (CApp::*)(int , int , int , int , int )), ".f3c36666", nullptr, 0, 32, &func);
}
...
double *Global_CEvent_lastEventTime;

namespace _var169
{
    static VariableDefinition varObj("Global_CEvent_lastEventTime", "!f20f1005(???????\?)75684489f02b442410", &Global_CEvent_lastEventTime, true, true);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CEvent::IsKeyboardPresent", typeid(bool (*)()), "!.4883ec08e8????????31d285", nullptr, 0, 0, &func);
}

bool CEvent::IsKeyboardPresent()
{
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CEvent::IsTouchActive", typeid(bool (*)(int )), ".4883ec08e8????????85c00f95c04883c408c3", nullptr, 0, 0, &func);
}

bool CEvent::IsTouchActive(int id)
{
	typedef bool (*custom_arg_funcptr_t)(int id_arg);
...
{
	typedef GL_Primitive *(*custom_arg_funcptr_t)(GL_Texture *tex_arg, std::vector<GL_TexVertex> *vertices_arg, GL_Color color_arg);
...
{
	typedef void (*custom_arg_funcptr_t)(std::vector<GL_TexVertex> *vertices_arg, float x_arg, float y_arg, float size_x_arg, float size_y_arg, float start_x_arg, float end_x_arg, float start_y_arg, float end_y_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ChoiceBox::OnTouch", typeid(void (ChoiceBox::*)(TouchAction , int , int , int , int , int )), "!.415783fe0441564155415455538b442438", nullptr, 0, 0, &func);
}

void ChoiceBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(ChoiceBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CloakingBox::OnRender", typeid(void (CloakingBox::*)(bool )), "!4154400fb6f655534889fbe830fbffff488bbbf8020000", nullptr, 0, 0, &func);
}

void CloakingBox::OnRender(bool ignoreStatus)
{
	typedef void (*custom_arg_funcptr_t)(CloakingBox *this_arg, bool ignoreStatus_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CloakingBox::OnTouch", typeid(void (CloakingBox::*)(TouchAction , int , int , int , int , int )), "!.41574589cf415641554589c541544189cc5589d5534889fb4883ec188b9700030000", nullptr, 0, 0, &func);
}

void CloakingBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(CloakingBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CloneBox::OnRender", typeid(void (CloneBox::*)(bool )), ".415731d241564989fe415541bd030000004154555389f34881ec", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CombatControl::OnRenderInterface", typeid(void (CombatControl::*)(bool )), "!.4155440fb6ee41544189f44489ee55488d6f2053", nullptr, 0, 0, &func);
}

void CombatControl::OnRenderInterface(bool front)
{
	typedef void (*custom_arg_funcptr_t)(CombatControl *this_arg, bool front_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CombatControl::GetSelectedCrew", typeid(CrewMember *(CombatControl::*)(int , int )), ".488b87????????4885c0742c", nullptr, 0, 0, &func);
}

CrewMember *CombatControl::GetSelectedCrew(int x, int y)
{
	typedef CrewMember *(*custom_arg_funcptr_t)(CombatControl *this_arg, int x_arg, int y_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CombatControl::OnTouchWeaponBoxes", typeid(bool (CombatControl::*)(TouchAction , int , int , int , int , int )), ".41574989ff488d7f2041564589ce41554589c54154", nullptr, 0, 0, &func);
}

bool CombatControl::OnTouchWeaponBoxes(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool (*custom_arg_funcptr_t)(CombatControl *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CombatControl::OnTouch", typeid(bool (CombatControl::*)(TouchAction , int , int , int , int , int )), ".4157f30f2ac1415641554589c541544189cc", nullptr, 0, 0, &func);
}

bool CombatControl::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool (*custom_arg_funcptr_t)(CombatControl *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
bool *TutorialManager_Tutorial_bGamePaused;

namespace _var295
{
    static VariableDefinition varObj("TutorialManager_Tutorial_bGamePaused", "!8897????????408835(???????\?)", &TutorialManager_Tutorial_bGamePaused, true, true);
}

namespace _func296
{
    static void *func = 0;
	static FunctionDefinition funcObj("CommandGui::SpaceBar", typeid(void (CommandGui::*)()), ".53488b87701900004889fb488b7810488b07", nullptr, 0, 0, &func);
}

void CommandGui::SpaceBar()
{
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CommandGui::UpdateShake", typeid(Pointf (CommandGui::*)()), ".415455534889fb4883ec30803dce????????0f84", nullptr, 0, 0, &func);
}

Pointf CommandGui::UpdateShake()
{
	typedef Pointf (*custom_arg_funcptr_t)(CommandGui *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CommandGui::RButtonDown", typeid(void (CommandGui::*)(int , int , bool )), ".4155415455534889fb4883ec0880bf????????007412", nullptr, 0, 0, &func);
}

void CommandGui::RButtonDown(int mX, int mY, bool shiftHeld)
{
	typedef void (*custom_arg_funcptr_t)(CommandGui *this_arg, int mX_arg, int mY_arg, bool shiftHeld_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CommandGui::RButtonUp", typeid(void (CommandGui::*)(int , int , bool )), ".f3c3", nullptr, 0, 0, &func);
}

void CommandGui::RButtonUp(int mX, int mY, bool shiftHeld)
{
	typedef void (*custom_arg_funcptr_t)(CommandGui *this_arg, int mX_arg, int mY_arg, bool shiftHeld_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CommandGui::OnLanguageChange", typeid(void (CommandGui::*)()), ".41574156415541544989fc488dbf????????55534881ec", nullptr, 0, 0, &func);
}

void CommandGui::OnLanguageChange()
{
	typedef void (*custom_arg_funcptr_t)(CommandGui *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ConfirmWindow::OnTouch", typeid(void (ConfirmWindow::*)(TouchAction , int , int , int , int , int )), ".415741564155415455534889fb4883ec18", nullptr, 0, 0, &func);
}

void ConfirmWindow::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(ConfirmWindow *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewControl::IsPointInCrewBoxes", typeid(bool (CrewControl::*)(int , int )), ".41574531ff4156415541544189d455534889fb4883ec18", nullptr, 0, 0, &func);
}

bool CrewControl::IsPointInCrewBoxes(int x, int y)
{
	typedef bool (*custom_arg_funcptr_t)(CrewControl *this_arg, int x_arg, int y_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewControl::ClearSelectedCrew", typeid(void (CrewControl::*)()), ".488b7708488b4f1031d231c04829f1", nullptr, 0, 0, &func);
}

void CrewControl::ClearSelectedCrew()
{
	typedef void (*custom_arg_funcptr_t)(CrewControl *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewControl::OnTouch", typeid(bool (CrewControl::*)(TouchAction , int , int , int , int , int , int , int , bool )), ".41574989ff4156415541544589c45589cd5389f34883ec58", nullptr, 0, 0, &func);
}

bool CrewControl::OnTouch(TouchAction action, int id, int x, int y, int wX, int wY, int initialX, int initialY, bool allowCrewSelection)
{
	typedef bool (*custom_arg_funcptr_t)(CrewControl *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int wX_arg, int wY_arg, int initialX_arg, int initialY_arg, bool allowCrewSelection_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func413::func;
	return execfunc(this, action, id, x, y, wX, wY, initialX, initialY, allowCrewSelection);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewControl::LButtonUp", typeid(void (CrewControl::*)(int , int , bool )), ".4154555380bf98000000004889fb75", nullptr, 0, 0, &func);
}

void CrewControl::LButtonUp(int mX, int mY, bool shiftHeld)
{
	typedef void (*custom_arg_funcptr_t)(CrewControl *this_arg, int mX_arg, int mY_arg, bool shiftHeld_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewControl::OnTouchButtons", typeid(bool (CrewControl::*)(TouchAction , int , int , int , int , int )), ".41574589c741564189ce41554189d541544189f4554489cd534889fb", nullptr, 0, 0, &func);
}

bool CrewControl::OnTouchButtons(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool (*custom_arg_funcptr_t)(CrewControl *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("DoorBox::OnTouch", typeid(void (DoorBox::*)(TouchAction , int , int , int , int , int )), ".41574589cf415641554589c541544189cc5589d5534889fb488dbf700200004883ec28", nullptr, 0, 0, &func);
}

void DoorBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(DoorBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("DoorBox::OnRender", typeid(void (DoorBox::*)(bool )), "!.41564189f64155415455534889fb4c8da370020000488dab00030000", nullptr, 0, 0, &func);
}

void DoorBox::OnRender(bool ignoreStatus)
{
	typedef void (*custom_arg_funcptr_t)(DoorBox *this_arg, bool ignoreStatus_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("DroneControl::RenderWarnings", typeid(void (DroneControl::*)()), "!534889fbe8????????f30f2a4338", nullptr, 0, 0, &func);
}

void DroneControl::RenderWarnings()
{
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("DroneControl::HolderLabel", typeid(TextString (DroneControl::*)()), ".534889fbbe????????4883ec", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("DroneControl::OnRender", typeid(void (DroneControl::*)(bool )), "!.5589f5be04000000534889fb4883ec08488b7f18", nullptr, 0, 0, &func);
}

void DroneControl::OnRender(bool front)
{
	typedef void (*custom_arg_funcptr_t)(DroneControl *this_arg, bool front_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("DroneControl::OnTouch", typeid(bool (DroneControl::*)(TouchAction , int , int , int , int , int )), "!.415741564155415455534889fb4883ec18488b7f18", nullptr, 0, 0, &func);
}

bool DroneControl::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool (*custom_arg_funcptr_t)(DroneControl *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("FocusWindow::OnTouch", typeid(void (FocusWindow::*)(TouchAction , int , int , int , int , int )), ".83fe04743b8b470c", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("GenericButton::OnTouch", typeid(bool (GenericButton::*)(TouchAction , int , int , int , int , int )), ".55534889fb4883ec180fb66f20c6474a00", nullptr, 0, 0, &func);
}

bool GenericButton::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool (*custom_arg_funcptr_t)(GenericButton *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("input_update", typeid(void (*)()), "803d49703f000075??c3????????????55534883ec", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("time_now", typeid(double (*)()), "4883ec08e8????????482b05", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("HackBox::DO_NOT_HOOK", typeid(void (HackBox::*)()), "b803000000c3662e0f1f840000000000b802000000c3662e0f1f840000000000", nullptr, 0, 0, &func);
}

namespace _func750
{
    static void *func = 0;
	static FunctionDefinition funcObj("HackBox::OnTouch", typeid(void (HackBox::*)(TouchAction , int , int , int , int , int )), ".f3c3", nullptr, 0, 0, &func);
}

void HackBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(HackBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("HackBox::OnRender", typeid(void (HackBox::*)(bool )), "!.55400fb6f6534889fb4883ec18e8??6e0300e8????0600f30f2a8300030000", nullptr, 0, 0, &func);
}

void HackBox::OnRender(bool ignoreStatus)
{
	typedef void (*custom_arg_funcptr_t)(HackBox *this_arg, bool ignoreStatus_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("LanguageChooser::OnTouch", typeid(void (LanguageChooser::*)(TouchAction , int , int , int , int , int )), "415741564189d6415541544531e4", nullptr, 0, 0, &func);
}

void LanguageChooser::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(LanguageChooser *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("LanguageChooser::MouseClick", typeid(void (LanguageChooser::*)(int , int )), ".488b7720488b4f2831d231c04829f148c1f9034885c97427", nullptr, 0, 0, &func);
}

void LanguageChooser::MouseClick(int mX, int mY)
{
	typedef void (*custom_arg_funcptr_t)(LanguageChooser *this_arg, int mX_arg, int mY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("MainMenu::MouseUp", typeid(void (MainMenu::*)(int , int )), "80bf4038000000751f80bfa8220000007506f3c3", nullptr, 0, 0, &func);
}

void MainMenu::MouseUp(int mX, int mY)
{
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("MainMenu::MouseRClick", typeid(void (MainMenu::*)(int , int )), ".80bf4038000000750980bfa8220000007506", nullptr, 0, 0, &func);
}

void MainMenu::MouseRClick(int mX, int mY)
{
	typedef void (*custom_arg_funcptr_t)(MainMenu *this_arg, int mX_arg, int mY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("MainMenu::OnTouch", typeid(void (MainMenu::*)(TouchAction , int , int , int , int , int )), ".41574589cb41564189ce41554589c541544189d4", nullptr, 0, 0, &func);
}

void MainMenu::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(MainMenu *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("MindBox::OnRender", typeid(void (MindBox::*)(bool )), "!.4154400fb6f655534889fbe8??6f0300448ba3700300008bab74030000e8??38", nullptr, 0, 0, &func);
}

void MindBox::OnRender(bool ignoreStatus)
{
	typedef void (*custom_arg_funcptr_t)(MindBox *this_arg, bool ignoreStatus_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("MindBox::OnTouch", typeid(void (MindBox::*)(TouchAction , int , int , int , int , int )), ".41574589c741564189f641554189cd41544189d4554489cd534889fb488dbfe00200004883ec38", nullptr, 0, 0, &func);
}

void MindBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(MindBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ParticleEmitter::OnRender", typeid(void (ParticleEmitter::*)()), "!41544989fc55498dac24????????53498d5c241c4883ec10", nullptr, 0, 0, &func);
}

void ParticleEmitter::OnRender()
{
	typedef void (*custom_arg_funcptr_t)(ParticleEmitter *this_arg);
...
{
	typedef GL_Primitive *(*custom_arg_funcptr_t)(ResourceControl *this_arg, GL_Texture *tex_arg, int x_arg, int y_arg, int rotation_arg, GL_Color color_arg, float alpha_arg, bool mirror_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Ship::GetSelectedDoor", typeid(Door *(Ship::*)(int , int , float )), ".4157415641554189d541544189f455534889fb4883ec38488b5728", nullptr, 0, 0, &func);
}

Door *Ship::GetSelectedDoor(int x, int y, float doorScale)
{
	typedef Door *(*custom_arg_funcptr_t)(Ship *this_arg, int x_arg, int y_arg, float doorScale_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Ship::GetRoomListConst", typeid(std::vector<Room*> (Ship::*)()), ".554889f84889f5534883ec284c8b461848c707", nullptr, 0, 0, &func);
}

std::vector<Room*> Ship::GetRoomListConst()
{
	typedef std::vector<Room*> (*custom_arg_funcptr_t)(Ship *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::GetShape", typeid(Globals::Rect (ShipManager::*)()), ".534889fb8b7e", nullptr, 0, 0, &func);
}

Globals::Rect ShipManager::GetShape()
{
	typedef Globals::Rect (*custom_arg_funcptr_t)(ShipManager *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::GetCrewList", typeid(std::vector<CrewMember*> (ShipManager::*)()), "!41544531c04531e4554889f553", nullptr, 0, 0, &func);
}

std::vector<CrewMember*> ShipManager::GetCrewList()
{
	typedef std::vector<CrewMember*> (*custom_arg_funcptr_t)(ShipManager *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipStatus::OnTouch", typeid(void (ShipStatus::*)(TouchAction , int , int , int , int , int )), ".f3c366666666662e0f1f8400", nullptr, 0, 0, &func);
}

void ShipStatus::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(ShipStatus *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
	typedef void (*custom_arg_funcptr_t)(SpaceManager *this_arg, int layers_arg, float alpha_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SpaceStatus::OnTouch", typeid(void (SpaceStatus::*)(TouchAction , int , int , int , int , int )), ".83ee0183fe0176", nullptr, 0, 0, &func);
}

void SpaceStatus::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(SpaceStatus *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemBox::CancelTouch", typeid(void (SystemBox::*)()), "488b07c787a4000000????????488b4070", nullptr, 0, 0, &func);
}

void SystemBox::CancelTouch()
{
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemBox::CloseTapBox", typeid(void (SystemBox::*)()), ".534889fbc687b000000000c6876002000000c687b100000000", nullptr, 0, 0, &func);
}

void SystemBox::CloseTapBox()
{
	typedef void (*custom_arg_funcptr_t)(SystemBox *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemBox::destructor", typeid(void (SystemBox::*)()), ".554889fd5331db4883ec1848c707????????66", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemBox::AdjustPowerTo", typeid(void (SystemBox::*)(int )), ".415541544189f4554889fd534883ec28488bbf", nullptr, 0, 0, &func);
}

void SystemBox::AdjustPowerTo(int newPower)
{
	typedef void (*custom_arg_funcptr_t)(SystemBox *this_arg, int newPower_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func1436::func;
	return execfunc(this, newPower);
}

namespace _func1437
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemBox::OnTouch", typeid(void (SystemBox::*)(TouchAction , int , int , int , int , int )), ".415741564589c641554189cd41544189d45589f5534889fb", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemControl::OnTouch", typeid(void (SystemControl::*)(TouchAction , int , int , int , int , int )), "4157415641554589cd41544589c4554889fd53", nullptr, 0, 0, &func);
}

void SystemControl::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(SystemControl *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemControl::IsAnySystemTapped", typeid(bool (SystemControl::*)()), "!.4c8b4710488b77184c29c648c1fe03", nullptr, 0, 0, &func);
}

bool SystemControl::IsAnySystemTapped()
{
	typedef bool (*custom_arg_funcptr_t)(SystemControl *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemControl::IsPointInTappedSystem", typeid(bool (SystemControl::*)(Point )), ".554889fd534883ec184c8b4f104c8b47184d29c8", nullptr, 0, 0, &func);
}

bool SystemControl::IsPointInTappedSystem(Point position)
{
	typedef bool (*custom_arg_funcptr_t)(SystemControl *this_arg, Point position_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemControl::CloseAll", typeid(void (SystemControl::*)()), ".5531c94889fd5331db4883ec08488b5710488b47184829d048c1f8034885c0742a", nullptr, 0, 0, &func);
}

void SystemControl::CloseAll()
{
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemControl::OnRender", typeid(void (SystemControl::*)(bool )), ".41544989fc5589f55389f34883ec50", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemControl::OnInit", typeid(void (SystemControl::*)(Point )), ".55534889fb4883ec584889773cbf", nullptr, 0, 0, &func);
}

void SystemControl::OnInit(Point position)
{
	typedef void (*custom_arg_funcptr_t)(SystemControl *this_arg, Point position_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemCustomBox::OnTouch", typeid(void (SystemCustomBox::*)(TouchAction , int , int , int , int , int )), ".534889fb488dbf700200004883ec108b442420890424e8????????0fb683ba020000", nullptr, 0, 0, &func);
}

void SystemCustomBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(SystemCustomBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SystemCustomBox::OnRender", typeid(void (SystemCustomBox::*)(bool )), "!.5589f5534889fb488dbf700200004883ec08e8????f6ff4883c408", nullptr, 0, 0, &func);
}

void SystemCustomBox::OnRender(bool ignoreStatus)
{
	typedef void (*custom_arg_funcptr_t)(SystemCustomBox *this_arg, bool ignoreStatus_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("TabbedWindow::GetWindow", typeid(FocusWindow *(TabbedWindow::*)(int )), ".488b4f38488b574031c04829ca48c1fa03", nullptr, 0, 0, &func);
}

FocusWindow *TabbedWindow::GetWindow(int tab)
{
	typedef FocusWindow *(*custom_arg_funcptr_t)(TabbedWindow *this_arg, int tab_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("TabbedWindow::SetTab", typeid(void (TabbedWindow::*)(uint )), ".41554189f541544989fc5531ed534883", nullptr, 0, 0, &func);
}

void TabbedWindow::SetTab(uint tab)
{
	typedef void (*custom_arg_funcptr_t)(TabbedWindow *this_arg, uint tab_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("TabbedWindow::Open", typeid(void (TabbedWindow::*)()), ".53807f08004889fb751e488b4720483947287414", nullptr, 0, 0, &func);
}

void TabbedWindow::Open()
{
	typedef void (*custom_arg_funcptr_t)(TabbedWindow *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("TeleportBox::OnTouch", typeid(void (TeleportBox::*)(TouchAction , int , int , int , int , int )), ".415741564589ce41554589c541544189cc5589d5534889fb", nullptr, 0, 0, &func);
}

void TeleportBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(TeleportBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("TeleportBox::OnRender", typeid(void (TeleportBox::*)(bool )), "!.4154400fb6f655534889fb4883ec10e8????????448ba398030000", nullptr, 0, 0, &func);
}

void TeleportBox::OnRender(bool ignoreStatus)
{
	typedef void (*custom_arg_funcptr_t)(TeleportBox *this_arg, bool ignoreStatus_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("TouchTooltip::OnTouch", typeid(bool (TouchTooltip::*)(TouchAction , int , int , int , int , int )), "534889fb4883ec1083fe010f84", nullptr, 0, 0, &func);
}

bool TouchTooltip::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool (*custom_arg_funcptr_t)(TouchTooltip *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("TouchTooltip::TakeTouch", typeid(bool (TouchTooltip::*)(int , int , int , int , int )), ".807f6400751b4129d0", nullptr, 0, 0, &func);
}

bool TouchTooltip::TakeTouch(int id, int x, int y, int initialX, int initialY)
{
	typedef bool (*custom_arg_funcptr_t)(TouchTooltip *this_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("TutorialManager::OnTouch", typeid(bool (TutorialManager::*)(TouchAction , int , int , int , int , int )), ".41574156415541544989fc55534883ec58803f00", nullptr, 0, 0, &func);
}

bool TutorialManager::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool (*custom_arg_funcptr_t)(TutorialManager *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("TutorialManager::OnRender", typeid(void (TutorialManager::*)()), ".41574156415541544989fc55534881ec", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("WeaponControl::OnTouch", typeid(bool (WeaponControl::*)(TouchAction , int , int , int , int , int )), "!.415741564155415455534889fb4883ec18488b7f18", nullptr, 0, 0, &func);
}

bool WeaponControl::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool (*custom_arg_funcptr_t)(WeaponControl *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("WeaponSystemBox::OnRender", typeid(void (WeaponSystemBox::*)(bool )), ".4154400fb6f655534889fb4883ec30e89c87ffff488b034889df", nullptr, 0, 0, &func);
}

void WeaponSystemBox::OnRender(bool ignoreStatus)
{
	typedef void (*custom_arg_funcptr_t)(WeaponSystemBox *this_arg, bool ignoreStatus_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("WeaponSystemBox::OnTouch", typeid(void (WeaponSystemBox::*)(TouchAction , int , int , int , int , int )), "!.41574989ff415641554589cd41544589c45589cd5389f34883ec18488b0789542408", nullptr, 0, 0, &func);
}

void WeaponSystemBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void (*custom_arg_funcptr_t)(WeaponSystemBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
