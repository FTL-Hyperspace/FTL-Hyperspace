...
{
    static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::OnLanguageChange", typeid(void (AchievementTracker::*)()), "415741564989fe4155415455534881ecb8000000488b", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::DO_NOT_HOOK", typeid(void (AchievementTracker::*)()), ".4157488d47484989f7415641554154554889fd4889c7534883ec38", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CSurface::__DO_NOT_HOOK", typeid(void (CSurface::*)()), "!4883ec08e8????????85c00f95c04883c408c3", nullptr, 0, 0, &func);
}

namespace _func155
{
    static void *func = 0;
	static FunctionDefinition funcObj("CSurface::IsFrameBufferSupported", typeid(bool (*)()), "!.4883ec08e8????????85c00f95c04883c408c3", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ChoiceBox::Close", typeid(void (ChoiceBox::*)()), "!c6470800c74774????????c3", nullptr, 0, 0, &func);
}

void ChoiceBox::Close()
{
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ChoiceBox::KeyDown", typeid(void (ChoiceBox::*)(SDLKey )), ".8b150edf550031c083fa", nullptr, 0, 0, &func);
}

void ChoiceBox::KeyDown(SDLKey sym)
{
	typedef void (*custom_arg_funcptr_t)(ChoiceBox *this_arg, SDLKey sym_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ChoiceBox::destructor", typeid(void (ChoiceBox::*)()), "!.415741564155415455534881ec????????488b", nullptr, 0, 0, &func);
}

void ChoiceBox::destructor()
{
	typedef void (*custom_arg_funcptr_t)(ChoiceBox *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ChoiceBox::GetChoice", typeid(int (ChoiceBox::*)()), ".8b477483", nullptr, 0, 0, &func);
}

int ChoiceBox::GetChoice()
{
	typedef int (*custom_arg_funcptr_t)(ChoiceBox *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ChoiceBox::GetPotentialChoice", typeid(int (ChoiceBox::*)()), ".8b4770c3", nullptr, 0, 0, &func);
}

int ChoiceBox::GetPotentialChoice()
{
	typedef int (*custom_arg_funcptr_t)(ChoiceBox *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ChoiceBox::IncreaseFont", typeid(void (ChoiceBox::*)()), "!.415455534889fb4883ec??????????74", nullptr, 0, 0, &func);
}

void ChoiceBox::IncreaseFont()
{
	typedef void (*custom_arg_funcptr_t)(ChoiceBox *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ChoiceBox::SetChoices", typeid(void (ChoiceBox::*)(std::string *, std::vector<ChoiceText> *, std::vector<ChoiceText> *)), ".415741564989ce41554989f5415455", nullptr, 0, 0, &func);
}

void ChoiceBox::SetChoices(std::string *mainText, std::vector<ChoiceText> *newChoices, std::vector<ChoiceText> *choicesSecond)
{
	typedef void (*custom_arg_funcptr_t)(ChoiceBox *this_arg, std::string *mainText_arg, std::vector<ChoiceText> *newChoices_arg, std::vector<ChoiceText> *choicesSecond_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func228::func;
	return execfunc(this, mainText, newChoices, choicesSecond);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ConfirmWindow::destructor", typeid(void (ConfirmWindow::*)()), "!.534889fb4883ec??48c7??????????488b????e8????????488d", nullptr, 0, 0, &func);
}

void ConfirmWindow::destructor()
{
	typedef void (*custom_arg_funcptr_t)(ConfirmWindow *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ControlButton::constructor", typeid(void (ControlButton::*)()), "534889f04889fb48c1f8", nullptr, 0, 0, &func);
}

void ControlButton::constructor()
{
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ControlsScreen::MouseMove", typeid(void (ControlsScreen::*)(int , int )), ".415641be????????41554c8d", nullptr, 0, 0, &func);
}

void ControlsScreen::MouseMove(int x, int y)
{
	typedef void (*custom_arg_funcptr_t)(ControlsScreen *this_arg, int x_arg, int y_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ControlsScreen::MouseClick", typeid(void (ControlsScreen::*)(int , int )), ".4154555380bf70010000004889fb", nullptr, 0, 0, &func);
}

void ControlsScreen::MouseClick(int x, int y)
{
	typedef void (*custom_arg_funcptr_t)(ControlsScreen *this_arg, int x_arg, int y_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("FocusWindow::destructor", typeid(void (FocusWindow::*)()), "!.48c707????????c3", nullptr, 0, 0, &func);
}

void FocusWindow::destructor()
{
	typedef void (*custom_arg_funcptr_t)(FocusWindow *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("LanguageChooser::destructor", typeid(void (LanguageChooser::*)()), "!554889fd534883ec??48c7??????????488b", nullptr, 0, 0, &func);
}

void LanguageChooser::destructor()
{
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("LanguageChooser::OnLoop", typeid(void (LanguageChooser::*)()), ".55534889fb4883ec??4863773883fe", nullptr, 0, 0, &func);
}

void LanguageChooser::OnLoop()
{
	typedef void (*custom_arg_funcptr_t)(LanguageChooser *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("LanguageChooser::OnInit", typeid(void (LanguageChooser::*)()), ".41564155415455534889fb4883ec??488b????4839", nullptr, 0, 0, &func);
}

void LanguageChooser::OnInit()
{
	typedef void (*custom_arg_funcptr_t)(LanguageChooser *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::Close", typeid(void (OptionsScreen::*)()), "4883ec??8b05????????83f8??74??83f8??", nullptr, 0, 0, &func);
}

void OptionsScreen::Close()
{
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::constructor", typeid(void (OptionsScreen::*)()), ".415455534889fb488d", nullptr, 0, 0, &func);
}

void OptionsScreen::constructor()
{
	typedef void (*custom_arg_funcptr_t)(OptionsScreen *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::DO_NOT_HOOK", typeid(void (OptionsScreen::*)()), ".415641554c8d????4154554889fd534883ec", nullptr, 0, 0, &func);
}

namespace _func762
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::OnLanguageChange", typeid(void (OptionsScreen::*)()), ".4881c7????????e9????????", nullptr, 0, 0, &func);
}

void OptionsScreen::OnLanguageChange()
{
	typedef void (*custom_arg_funcptr_t)(OptionsScreen *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::Open", typeid(void (OptionsScreen::*)(bool )), ".4157415641554154554889fdbf????????5389f3", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::CheckSelection", typeid(void (OptionsScreen::*)()), "!.534889fbe8????????85c078??4889df", nullptr, 0, 0, &func);
}

void OptionsScreen::CheckSelection()
{
	typedef void (*custom_arg_funcptr_t)(OptionsScreen *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::OnInit", typeid(void (OptionsScreen::*)()), ".415455534889fbbf????????488d", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::KeyDown", typeid(bool (OptionsScreen::*)(SDLKey )), ".41574156415541544189f4554889fd53", nullptr, 0, 0, &func);
}

bool OptionsScreen::KeyDown(SDLKey sym)
{
	typedef bool (*custom_arg_funcptr_t)(OptionsScreen *this_arg, SDLKey sym_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::OnRender", typeid(void (OptionsScreen::*)()), ".4155415455534889fb4883ec3880bf280c000000", nullptr, 0, 0, &func);
}

void OptionsScreen::OnRender()
{
	typedef void (*custom_arg_funcptr_t)(OptionsScreen *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::MouseMove", typeid(void (OptionsScreen::*)(int , int )), ".41554189d541544189f455534889fb4883ec??80", nullptr, 0, 0, &func);
}

void OptionsScreen::MouseMove(int x, int y)
{
	typedef void (*custom_arg_funcptr_t)(OptionsScreen *this_arg, int x_arg, int y_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::MouseClick", typeid(void (OptionsScreen::*)(int , int )), ".415455534889fb4883ec??80bf280c0000??0f85", nullptr, 0, 0, &func);
}

void OptionsScreen::MouseClick(int x, int y)
{
	typedef void (*custom_arg_funcptr_t)(OptionsScreen *this_arg, int x_arg, int y_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("OptionsScreen::destructor", typeid(void (OptionsScreen::*)()), "!.554889fd488d??????????534883ec", nullptr, 0, 0, &func);
}

void OptionsScreen::destructor()
{
	typedef void (*custom_arg_funcptr_t)(OptionsScreen *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Settings::ToggleVSync", typeid(void (*)()), "!.0fb635????????bf????????31c083f601", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Settings::ToggleFullScreen", typeid(void (*)()), ".8b05????????8d????31c083fa??", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SlideBar::OnRender", typeid(void (SlideBar::*)()), "5548bd????????????????534889fb4883ec38", nullptr, 0, 0, &func);
}

void SlideBar::OnRender()
{
	typedef void (*custom_arg_funcptr_t)(SlideBar *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SlideBar::MouseClick", typeid(void (SlideBar::*)(int , int )), "534889fb4883ec10807f10", nullptr, 0, 0, &func);
}

void SlideBar::MouseClick(int x, int y)
{
	typedef void (*custom_arg_funcptr_t)(SlideBar *this_arg, int x_arg, int y_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SoundControl::SetMusicVolume", typeid(void (SoundControl::*)(float )), "f30f5905????????534889fb", nullptr, 0, 0, &func);
}

void SoundControl::SetMusicVolume(float val)
{
	typedef void (*custom_arg_funcptr_t)(SoundControl *this_arg, float val_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SoundControl::GetMusicVolume", typeid(float (SoundControl::*)()), ".f30f2a????f30f5e05????????c3", nullptr, 0, 0, &func);
}

float SoundControl::GetMusicVolume()
{
	typedef float (*custom_arg_funcptr_t)(SoundControl *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SoundControl::GetSoundVolume", typeid(float (SoundControl::*)()), ".f30f2a????f30f5e05????????c3", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SoundControl::SetSoundVolume", typeid(void (SoundControl::*)(float )), ".f30f5905????????803f00f30f2cc0", nullptr, 0, 0, &func);
}

void SoundControl::SetSoundVolume(float val)
{
	typedef void (*custom_arg_funcptr_t)(SoundControl *this_arg, float val_arg);
