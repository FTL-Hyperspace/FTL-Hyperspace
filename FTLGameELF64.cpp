...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Asteroid::GetType", typeid(int (Asteroid::*)()), "!.b802000000c3", nullptr, 0, 0, &func);
}

int Asteroid::GetType()
{
	typedef int (*custom_arg_funcptr_t)(Asteroid *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BeamWeapon::SetMovingTarget", typeid(void (BeamWeapon::*)(Targetable *)), "554889fd4889f7534889f34883ec08488b06", nullptr, 0, 0, &func);
}

void BeamWeapon::SetMovingTarget(Targetable *target)
{
	typedef void (*custom_arg_funcptr_t)(BeamWeapon *this_arg, Targetable *target_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BeamWeapon::SaveProjectile", typeid(void (BeamWeapon::*)(int )), ".!554889fd5389f34883ec??e880810100f30f1085", nullptr, 0, 0, &func);
}

void BeamWeapon::SaveProjectile(int fd)
{
	typedef void (*custom_arg_funcptr_t)(BeamWeapon *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BeamWeapon::LoadProjectile", typeid(void (BeamWeapon::*)(int )), ".!5589f5534889fb4883ec??e8????????89ef", nullptr, 0, 0, &func);
}

void BeamWeapon::LoadProjectile(int fd)
{
	typedef void (*custom_arg_funcptr_t)(BeamWeapon *this_arg, int fd_arg);
...
void BeamWeapon::constructor(Pointf position, int ownerId, int targetId, Pointf target, Pointf target2, int length, Targetable *targetable, float heading)
{
	typedef void (*custom_arg_funcptr_t)(BeamWeapon *this_arg, Pointf position_arg, int ownerId_arg, int targetId_arg, Pointf target_arg, Pointf target2_arg, int length_arg, Targetable *targetable_arg, float heading_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func76::func;
	return execfunc(this, position, ownerId, targetId, target, target2, length, targetable, heading);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BeamWeapon::SetWeaponAnimation", typeid(void (BeamWeapon::*)(WeaponAnimation *)), "!.4889b7f0020000c3", nullptr, 0, 0, &func);
}

void BeamWeapon::SetWeaponAnimation(WeaponAnimation *animation)
{
	typedef void (*custom_arg_funcptr_t)(BeamWeapon *this_arg, WeaponAnimation *animation_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func79::func;
	return execfunc(this, animation);
}

namespace _func80
{
    static void *func = 0;
	static FunctionDefinition funcObj("BeamWeapon::GetType", typeid(int (BeamWeapon::*)()), "!.b805000000c3", nullptr, 0, 0, &func);
}

int BeamWeapon::GetType()
{
	typedef int (*custom_arg_funcptr_t)(BeamWeapon *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BoarderPodDrone::SaveState", typeid(void (BoarderPodDrone::*)(int )), ".554889fd5389f34883ec??e8a0fdffff0fb6b5????????89dfe8????????0fb6", nullptr, 0, 0, &func);
}

void BoarderPodDrone::SaveState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(BoarderPodDrone *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BoarderPodDrone::LoadState", typeid(void (BoarderPodDrone::*)(int )), ".41574156415541545589f5534889fb4883ec", nullptr, 0, 0, &func);
}

void BoarderPodDrone::LoadState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(BoarderPodDrone *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BombProjectile::SaveProjectile", typeid(void (BombProjectile::*)(int )), "!554889fd5389f34883ec08e8f0340100", nullptr, 0, 0, &func);
}

void BombProjectile::SaveProjectile(int fd)
{
	typedef void (*custom_arg_funcptr_t)(BombProjectile *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BombProjectile::LoadProjectile", typeid(void (BombProjectile::*)(int )), ".!554889fd5389f34883ec08e8c03a0100", nullptr, 0, 0, &func);
}

void BombProjectile::LoadProjectile(int fd)
{
	typedef void (*custom_arg_funcptr_t)(BombProjectile *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("BombProjectile::GetType", typeid(int (BombProjectile::*)()), ".!b804000000c3", nullptr, 0, 0, &func);
}

int BombProjectile::GetType()
{
	typedef int (*custom_arg_funcptr_t)(BombProjectile *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CombatControl::SaveState", typeid(void (CombatControl::*)(int )), ".!89f00fb6b7????????89c7e9", nullptr, 0, 0, &func);
}

void CombatControl::SaveState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(CombatControl *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CombatControl::LoadState", typeid(void (CombatControl::*)(int )), ".!83", nullptr, 0, 0, &func);
}

void CombatControl::LoadState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(CombatControl *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CombatDrone::SaveState", typeid(void (CombatDrone::*)(int )), ".!554889fd5389f34883ec08e8????????f30f10854003000089df", nullptr, 0, 0, &func);
}

void CombatDrone::SaveState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(CombatDrone *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CombatDrone::LoadState", typeid(void (CombatDrone::*)(int )), ".5589f5534889fb4883ec08e8????????89efe8????????f30f118340030000", nullptr, 0, 0, &func);
}

void CombatDrone::LoadState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(CombatDrone *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CommandGui::ExportData", typeid(void (CommandGui::*)(int )), "41554189f5488d", nullptr, 0, 0, &func);
}

void CommandGui::ExportData(int fd)
{
	typedef void (*custom_arg_funcptr_t)(CommandGui *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CommandGui::ConfirmUpgrades", typeid(void (CommandGui::*)()), ".80bf10360000", nullptr, 0, 0, &func);
}

void CommandGui::ConfirmUpgrades()
{
	typedef void (*custom_arg_funcptr_t)(CommandGui *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CommandGui::ClearWriteError", typeid(void (CommandGui::*)()), ".c6879848000000", nullptr, 0, 0, &func);
}

void CommandGui::ClearWriteError()
{
	typedef void (*custom_arg_funcptr_t)(CommandGui *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CommandGui::ShowWriteError", typeid(void (CommandGui::*)()), ".415741564155415455534889fb4881ec1801000080", nullptr, 0, 0, &func);
}

void CommandGui::ShowWriteError()
{
	typedef void (*custom_arg_funcptr_t)(CommandGui *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewAnimation::SaveState", typeid(void (CrewAnimation::*)(int )), "!.554889fd5389f331f6", nullptr, 0, 0, &func);
}

void CrewAnimation::SaveState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(CrewAnimation *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewAnimation::LoadState", typeid(void (CrewAnimation::*)(int )), "!.554889fd89f7", nullptr, 0, 0, &func);
}

void CrewAnimation::LoadState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(CrewAnimation *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewDrone::SetInstantPowered", typeid(void (CrewDrone::*)()), "55488daf90070000", nullptr, 0, 0, &func);
}
...
{
	typedef void (*custom_arg_funcptr_t)(CrewDrone *this_arg, bool powered_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewDrone::SetDeployed", typeid(void (CrewDrone::*)(bool )), "5589f5534889fb4883ec084084", nullptr, 0, 0, &func);
}

void CrewDrone::SetDeployed(bool deploy)
{
	typedef void (*custom_arg_funcptr_t)(CrewDrone *this_arg, bool deploy_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func418::func;
	return execfunc(this, deploy);
}

namespace _func419
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewDrone::ShipDamage", typeid(bool (CrewDrone::*)(float )), "0f57c90f2ec877??31", nullptr, 0, 0, &func);
}
...
namespace _var458
{
    static VariableDefinition varObj("iDeathCount", "!.89eff3410f1184??????????e8????????8905(???????\?)", &iDeathCount, true, true);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrystalAlien::SaveState", typeid(void (CrystalAlien::*)(int )), "!554889fd5389f34883ec08e8????????f30f108544070000", nullptr, 0, 0, &func);
}

void CrystalAlien::SaveState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(CrystalAlien *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrystalAlien::LoadState", typeid(void (CrystalAlien::*)(int )), ".5589f5534889fb4883ec08e8????????89efe8????????f30f118344070000", nullptr, 0, 0, &func);
}

void CrystalAlien::LoadState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(CrystalAlien *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Door::Close", typeid(void (Door::*)()), ".55534889fb4883ec08807f2c", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Drone::SaveState", typeid(void (Drone::*)(int )), "!f30f10473489f7e9????????", nullptr, 0, 0, &func);
}

void Drone::SaveState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(Drone *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Drone::LoadState", typeid(void (Drone::*)(int )), ".!534889fb89f7e8????????f30f11", nullptr, 0, 0, &func);
}

void Drone::LoadState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(Drone *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("HackingDrone::SaveState", typeid(void (HackingDrone::*)(int )), ".!554889fd5389f34883ec08e8????????f30f108560030000", nullptr, 0, 0, &func);
}

void HackingDrone::SaveState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(HackingDrone *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("HackingDrone::LoadState", typeid(void (HackingDrone::*)(int )), ".!554889fd5389f34883ec08e8????????89dfe8????????f30f118560030000", nullptr, 0, 0, &func);
}

void HackingDrone::LoadState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(HackingDrone *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("HackingSystem::SaveState", typeid(void (HackingSystem::*)(int )), ".!554889fd5389f34883ec080fb6b75????????9dfe8", nullptr, 0, 0, &func);
}

void HackingSystem::SaveState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(HackingSystem *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("HackingSystem::LoadState", typeid(void (HackingSystem::*)(int )), ".!4154554889fd89f74c8da5????????5389f3e8", nullptr, 0, 0, &func);
}

void HackingSystem::LoadState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(HackingSystem *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("LaserBlast::SaveProjectile", typeid(void (LaserBlast::*)(int )), ".!554889fd5389f34883ec08e8", nullptr, 0, 0, &func);
}

void LaserBlast::SaveProjectile(int fd)
{
	typedef void (*custom_arg_funcptr_t)(LaserBlast *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("LaserBlast::LoadProjectile", typeid(void (LaserBlast::*)(int )), ".5589f5534889fb4883ec08e8", nullptr, 0, 0, &func);
}

void LaserBlast::LoadProjectile(int fd)
{
	typedef void (*custom_arg_funcptr_t)(LaserBlast *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("LaserBlast::GetType", typeid(int (LaserBlast::*)()), "!.b801000000c3", nullptr, 0, 0, &func);
}

int LaserBlast::GetType()
{
	typedef int (*custom_arg_funcptr_t)(LaserBlast *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Missile::GetType", typeid(int (Missile::*)()), "!.b803000000c3", nullptr, 0, 0, &func);
}

int Missile::GetType()
{
	typedef int (*custom_arg_funcptr_t)(Missile *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("PDSFire::SaveProjectile", typeid(void (PDSFire::*)(int )), ".!554889fd5389f34883ec08e8c0fcfffff", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("PDSFire::LoadProjectile", typeid(void (PDSFire::*)(int )), ".!554889fd5389f34883ec08e860f1ffff89dfe8", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("PDSFire::GetType", typeid(int (PDSFire::*)()), "!.b806000000c3", nullptr, 0, 0, &func);
}

int PDSFire::GetType()
{
	typedef int (*custom_arg_funcptr_t)(PDSFire *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Projectile::ForceRenderLayer", typeid(int (Projectile::*)()), ".!b8", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Projectile::DO_NOT_HOOK_1", typeid(void (Projectile::*)()), ".!f3c3", nullptr, 0, 0, &func);
}

namespace _func885
{
    static void *func = 0;
	static FunctionDefinition funcObj("Projectile::DO_NOT_HOOK_2", typeid(void (Projectile::*)()), ".!f3c3", nullptr, 0, 0, &func);
}

namespace _func886
{
    static void *func = 0;
	static FunctionDefinition funcObj("Projectile::SetWeaponAnimation", typeid(void (Projectile::*)(WeaponAnimation &)), ".!f3c3", nullptr, 0, 0, &func);
}

void Projectile::SetWeaponAnimation(WeaponAnimation &animation)
{
	typedef void (*custom_arg_funcptr_t)(Projectile *this_arg, WeaponAnimation &animation_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Projectile::SetMovingTarget", typeid(void (Projectile::*)(Targetable *)), ".!f3c3", nullptr, 0, 0, &func);
}

void Projectile::SetMovingTarget(Targetable *target)
{
	typedef void (*custom_arg_funcptr_t)(Projectile *this_arg, Targetable *target_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Projectile::SaveProjectile", typeid(void (Projectile::*)(int )), ".554889fd5389f34883ec??f30f104718", nullptr, 0, 0, &func);
}

void Projectile::SaveProjectile(int fd)
{
	typedef void (*custom_arg_funcptr_t)(Projectile *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Projectile::LoadProjectile", typeid(void (Projectile::*)(int )), ".!41574156415541544189f4", nullptr, 0, 0, &func);
}

void Projectile::LoadProjectile(int fd)
{
	typedef void (*custom_arg_funcptr_t)(Projectile *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Projectile::GetType", typeid(int (Projectile::*)()), ".31c0c3", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Ship::SaveState", typeid(void (Ship::*)(int )), ".415531c941544531e45589f5534889fb", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipAI::Save", typeid(void (ShipAI::*)(int )), "!.554889fd5389f34883ec080fb6b739", nullptr, 0, 0, &func);
}

void ShipAI::Save(int fd)
{
	typedef void (*custom_arg_funcptr_t)(ShipAI *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipEvent::Save", typeid(void (ShipEvent::*)(int )), "!554889fd5389f34883ec080fb637", nullptr, 0, 0, &func);
}

void ShipEvent::Save(int fd)
{
	typedef void (*custom_arg_funcptr_t)(ShipEvent *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SpaceDrone::SaveState", typeid(void (SpaceDrone::*)(int )), "!.554889fd5389f34883ec08e8????????8b7558", nullptr, 0, 0, &func);
}

void SpaceDrone::SaveState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(SpaceDrone *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SpaceDrone::LoadState", typeid(void (SpaceDrone::*)(int )), "!.554889fd5389f34883ec08e8????????89dfe8????????89df", nullptr, 0, 0, &func);
}

void SpaceDrone::LoadState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(SpaceDrone *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SpaceDrone::GetSpeed", typeid(Pointf (SpaceDrone::*)()), ".4883ec28807f100074", nullptr, 0, 0, &func);
}

Pointf SpaceDrone::GetSpeed()
{
	typedef Pointf (*custom_arg_funcptr_t)(SpaceDrone *this_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SuperShieldDrone::GetWeaponCooldown", typeid(float (SuperShieldDrone::*)()), "488bbf58010000f30f10", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SuperShieldDrone::SaveState", typeid(void (SuperShieldDrone::*)(int )), "!.554889fd5389f34883ec08e8????????f30f1085????????4883c4", nullptr, 0, 0, &func);
}

void SuperShieldDrone::SaveState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(SuperShieldDrone *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("SuperShieldDrone::LoadState", typeid(void (SuperShieldDrone::*)(int )), "!.5589f5534889fb4883ec08e8????????89efe8????????f30f1183????????4883c408", nullptr, 0, 0, &func);
}

void SuperShieldDrone::LoadState(int fd)
{
	typedef void (*custom_arg_funcptr_t)(SuperShieldDrone *this_arg, int fd_arg);
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("WeaponAnimation::LoadState", typeid(void (WeaponAnimation::*)(int )), ".554889fd5389f34883ec08e8", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("WorldManager::CheckForNewLocation", typeid(bool (WorldManager::*)(bool )), ".5589f5534889fb4883ec78", nullptr, 0, 0, &func);
}

bool WorldManager::CheckForNewLocation(bool savingGame)
{
	typedef bool (*custom_arg_funcptr_t)(WorldManager *this_arg, bool savingGame_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func1676::func;
	return execfunc(this, savingGame);
}
