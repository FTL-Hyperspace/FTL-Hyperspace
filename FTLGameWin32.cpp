...
{
	typedef GL_Primitive *__attribute__((thiscall)) (*custom_arg_funcptr_t)(ResourceControl *this_arg, GL_Texture *tex_arg, int x_arg, int y_arg, int rotation_arg, GL_Color color_arg, float alpha_arg, bool mirror_arg);
...
namespace _func1021
{
    static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("ShipManager::GetNetDodgeFactor", typeid(int (ShipManager::*)()), ".5589e5565389cb83e4f0e8????????89c68b03", argdata, 1, 1, &func);
}
...
namespace _func1074
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("ShipManager::GetShape", typeid(Globals::Rect (ShipManager::*)()), ".5589e55389cb83e4f083ec108b45088b4004890424", argdata, 2, 1, &func);
}

Globals::Rect ShipManager::GetShape()
{
	typedef Globals::Rect __attribute__((thiscall)) (*custom_arg_funcptr_t)(ShipManager *this_arg);
...
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(SpaceManager *this_arg, int layers_arg, float alpha_arg);
...
namespace _func1383
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("SystemCustomBox::OnTouch", typeid(void (SystemCustomBox::*)(TouchAction , int , int , int , int , int )), ".578d7c240883e4f0ff77fc5589e557565389cb83ec3c8b078b77", argdata, 7, 5, &func);
}

void SystemCustomBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(SystemCustomBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
namespace _func1384
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("SystemCustomBox::OnRender", typeid(void (SystemCustomBox::*)(bool )), "!.578d7c240883e4f0ff77fc5589e557565389ce8d89????????83ec1c", argdata, 2, 5, &func);
}

void SystemCustomBox::OnRender(bool ignoreStatus)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(SystemCustomBox *this_arg, bool ignoreStatus_arg);
...
namespace _func1392
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("TabbedWindow::GetWindow", typeid(FocusWindow *(TabbedWindow::*)(int )), ".538b412c8b59288b54240829d8c1f802", argdata, 2, 1, &func);
}

FocusWindow *TabbedWindow::GetWindow(int tab)
{
	typedef FocusWindow *__attribute__((thiscall)) (*custom_arg_funcptr_t)(TabbedWindow *this_arg, int tab_arg);
...
namespace _func1394
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("TabbedWindow::SetTab", typeid(void (TabbedWindow::*)(uint )), "578d????0883e4f0ff????5589f889e557565389cf81ecac0000008b??8b", argdata, 2, 5, &func);
}

void TabbedWindow::SetTab(uint tab)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(TabbedWindow *this_arg, uint tab_arg);
...
namespace _func1398
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TeleportBox::OnTouch", typeid(void (TeleportBox::*)(TouchAction , int , int , int , int , int )), ".578d7c240883e4f0ff77fc5589e557565389cb83ec6c8b078b4f08", argdata, 7, 5, &func);
}

void TeleportBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(TeleportBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
namespace _func1399
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("TeleportBox::OnRender", typeid(void (TeleportBox::*)(bool )), "!.578d7c240883e4f0ff77fc5589e557565389cb83ec4c0fb607890424e8", argdata, 2, 5, &func);
}

void TeleportBox::OnRender(bool ignoreStatus)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(TeleportBox *this_arg, bool ignoreStatus_arg);
...
namespace _func1452
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TouchTooltip::OnTouch", typeid(bool (TouchTooltip::*)(TouchAction , int , int , int , int , int )), "5589e5565383e4f083ec208b45088b517883f801", argdata, 7, 1, &func);
}

bool TouchTooltip::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool __attribute__((thiscall)) (*custom_arg_funcptr_t)(TouchTooltip *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
namespace _func1453
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TouchTooltip::TakeTouch", typeid(bool (TouchTooltip::*)(int , int , int , int , int )), ".8079680075248b4424048b5164c7", argdata, 6, 1, &func);
}

bool TouchTooltip::TakeTouch(int id, int x, int y, int initialX, int initialY)
{
	typedef bool __attribute__((thiscall)) (*custom_arg_funcptr_t)(TouchTooltip *this_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
namespace _func1456
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TutorialManager::OnInit", typeid(void (TutorialManager::*)(ShipManager *, CommandGui *, CrewControl *, Upgrades *, CombatControl *, SystemControl *, TabbedWindow *)), ".578d7c240883e4f0ff77fc5589e557565389cb83ec7c8b470c8b378b4f04", argdata, 8, 5, &func);
}
...
namespace _func1457
{
    static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("TutorialManager::OnRender", typeid(void (TutorialManager::*)()), ".5589e557565381ec????????8b4508803800", argdata, 1, 5, &func);
}
...
namespace _func1458
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TutorialManager::OnTouch", typeid(bool (TutorialManager::*)(TouchAction , int , int , int , int , int )), ".578d7c240883e4f0ff77fc5589e557565383ec6c", argdata, 7, 1, &func);
}

bool TutorialManager::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool __attribute__((thiscall)) (*custom_arg_funcptr_t)(TutorialManager *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
namespace _func1538
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("WeaponSystemBox::OnRender", typeid(void (WeaponSystemBox::*)(bool )), ".578d7c240883e4f0ff77fc5589e557565389cb83ec5c0fb607", argdata, 2, 5, &func);
}

void WeaponSystemBox::OnRender(bool ignoreStatus)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(WeaponSystemBox *this_arg, bool ignoreStatus_arg);
...
namespace _func1539
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("WeaponSystemBox::OnTouch", typeid(void (WeaponSystemBox::*)(TouchAction , int , int , int , int , int )), "!.578d7c240883e4f0ff77fc5589e557565389cb83ec4c8b07", argdata, 7, 5, &func);
}

void WeaponSystemBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(WeaponSystemBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
