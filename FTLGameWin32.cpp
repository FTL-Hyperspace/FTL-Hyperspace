...
namespace _func0
{
	...
	static FunctionDefinition funcObj("AchievementTracker::OnLanguageChange", typeid(void (AchievementTracker::*)()), "578d7c240883e4f0ff77fc5589e557565381ec??0400008b51", argdata, 1, 5, &func);
}
...
namespace _func3
{
	...
	static FunctionDefinition funcObj("DO_NOT_HOOK", typeid(void (*)()), ".578d7c240883e4f0ff77fc55", argdata, 0, 4, &func);
}
...
namespace _func4
{
	...
	static FunctionDefinition funcObj("AchievementTracker::GetShipMarker", typeid(int (AchievementTracker::*)(const std::string &, const std::string &)), ".578d7c240883e4f0ff77fc55", argdata, 3, 1, &func);
}
...
namespace _func10
{
	...
	static FunctionDefinition funcObj("AchievementTracker::SetAchievement", typeid(void (AchievementTracker::*)(const std::string &, bool , bool )), ".578d7c240883e4f0ff77fc5589e557565381ec8c000000", argdata, 4, 5, &func);
}
...
namespace _func41
{
	static void *func = 0;
	static const short *argdata = NULL;
	static FunctionDefinition funcObj("DO_NOT_HOOK", typeid(void (*)()), "8079780075??????????????????????578d7c240883e4f0ff77fc5589e5575389cb83ec20", argdata, 0, 4, &func);
}
...
namespace _func42
{
	static void *func = 0;
	static const short *argdata = NULL;
	static FunctionDefinition funcObj("DO_NOT_HOOK_2", typeid(void (*)()), ".8d65f45b5e5f5d8d67f85fc20c00", argdata, 0, 4, &func);
}
...
namespace _func43
{
	static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("ArmamentControl::KeyDown", typeid(bool (ArmamentControl::*)(SDLKey )), ".578d7c240883e4f0ff77fc5589e5575653", argdata, 2, 1, &func);
}
...
namespace _func45
{
	static void *func = 0;
	static const short *argdata = NULL;
	static FunctionDefinition funcObj("DO_NOT_HOOK_3", typeid(void (*)()), ".578d7c240883e4f0ff77fc5589e5575653", argdata, 0, 4, &func);
}
...
namespace _func46
{
	static void *func = 0;
	static const short *argdata = NULL;
	static FunctionDefinition funcObj("DO_NOT_HOOK_4", typeid(void (*)()), ".578d7c240883e4f0ff77fc5589e5575653", argdata, 0, 4, &func);
}
...
namespace _func47
{
	static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("ArmamentControl::CreateHolderTab", typeid(void (ArmamentControl::*)()), ".578d7c240883e4f0ff77fc5589e5575653", argdata, 1, 5, &func);
}
...
namespace _func48
{
	...
	static FunctionDefinition funcObj("ArmamentControl::SetPosition", typeid(void (ArmamentControl::*)(Point )), ".5589e5565383e4f083ec108b450839411c", argdata, 2, 5, &func);
}
...
namespace _func49
{
	static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("ArmamentControl::LinkShip", typeid(void (ArmamentControl::*)(ShipManager *)), ".578d7c240883e4f0ff77fc5589e5575653", argdata, 2, 5, &func);
}
...
namespace _func53
{
	static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("ArtillerySystem::OnLoop", typeid(void (ArtillerySystem::*)()), ".578d7c240883e4f0ff77fc5589e557565389??83ec5c", argdata, 1, 5, &func);
}
...
void ShipSystem::RenderPowerBoxes(int x, int y, int width, int height, int gap, int heightMod, bool flash)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(ShipSystem *this_arg, int x_arg, int y_arg, int width_arg, int height_arg, int gap_arg, int heightMod_arg, bool flash_arg);
...
{
	typedef int __attribute__((thiscall)) (*custom_arg_funcptr_t)(SoundControl *this_arg, const std::string &soundName_arg, float volume_arg, char loop_arg);
...
void SpaceManager::OnRenderProjectiles(int unk1, int unk2)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(SpaceManager *this_arg, int unk1_arg, int unk2_arg);
