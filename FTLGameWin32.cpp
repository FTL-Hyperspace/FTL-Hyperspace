...
namespace _func227
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("CloakingSystem::SetTurnedOn", typeid(void (CloakingSystem::*)(bool )), ".578d????0883e4f0ff????5589e557565389cb83ec1c8b??e8????????", argdata, 2, 5, &func);
}

void CloakingSystem::SetTurnedOn(bool val)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(CloakingSystem *this_arg, bool val_arg);
