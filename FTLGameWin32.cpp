...
namespace _func650
{
    static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("FocusWindow::constructor", typeid(void (FocusWindow::*)()), "578d????0883e4f0ff????5589e5575389cb8d490883ec10c741f8b8c38b00c6", argdata, 1, 5, &func);
}
...
namespace _func1330
{
    static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TabbedWindow::AddWindow", typeid(void (TabbedWindow::*)(string *, Button *, FocusWindow *)), "578d????0883e4f0ff????5589e557565389cb83ec3c8b????8b??85c974??8b01", argdata, 4, 5, &func);
}

void TabbedWindow::AddWindow(string *name, Button *button, FocusWindow *window)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(TabbedWindow *this_arg, string *name_arg, Button *button_arg, FocusWindow *window_arg);
