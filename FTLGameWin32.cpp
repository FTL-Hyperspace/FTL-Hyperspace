...
namespace _func275
{
	static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("CommandGui::Restart", typeid(void (CommandGui::*)()), "578d7c240883e4f0ff77fc5589e557568db178010000", argdata, 1, 5, &func);
}
...
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(CompleteShip *this_arg, SpaceManager *space_arg, bool bPlayerShip_arg, int iShipId_arg);
...
namespace _func300
{
	static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("CompleteShip::destructor", typeid(void (CompleteShip::*)(int )), ".578d7c240883e4??ff77fc5589e557565389ce83ec2cc701", argdata, 2, 5, &func);
}

void CompleteShip::destructor(int unk)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(CompleteShip *this_arg, int unk_arg);
...
namespace _func854
{
	static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("ScoreKeeper::SetShipBlueprint", typeid(void (ScoreKeeper::*)(std::string *)), "5781c1640200008d7c240883e4f0ff77fc5589e557", argdata, 2, 5, &func);
}

void ScoreKeeper::SetShipBlueprint(std::string *blueprint)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(ScoreKeeper *this_arg, std::string *blueprint_arg);
...
namespace _func896
{
	static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("Ship::ClearImages", typeid(void (Ship::*)()), "5589e55389cb83e4f083ec108b8180000000", argdata, 1, 5, &func);
}
