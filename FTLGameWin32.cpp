...
namespace _func541
{
	static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("EngineSystem::GetDodgeFactor", typeid(int (EngineSystem::*)()), "5589e55389cb83e4??83ec208b414885c07e??80794c0075??31c08944????", argdata, 1, 1, &func);
}

int EngineSystem::GetDodgeFactor()
{
	typedef int __attribute__((thiscall)) (*custom_arg_funcptr_t)(EngineSystem *this_arg);
...
namespace _func542
{
	static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("EngineSystem::GetEngineSpeed", typeid(float (EngineSystem::*)()), "5731d28d????0883e4??ff????5589e557565389cb83ec4c8b414885c07e??", argdata, 1, 1, &func);
}

float EngineSystem::GetEngineSpeed()
{
	typedef float __attribute__((thiscall)) (*custom_arg_funcptr_t)(EngineSystem *this_arg);
