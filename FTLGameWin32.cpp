...
namespace _func980
{
	static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("ShipManager::SetTarget", typeid(void (ShipManager::*)(ShipManager *)), ".578d7c240883e4f0ff77fc5589e557565389ce83ec4c8b0789c78945bc", argdata, 2, 5, &func);
}

void ShipManager::SetTarget(ShipManager *target)
{
	typedef void __attribute__((thiscall)) (*custom_arg_funcptr_t)(ShipManager *this_arg, ShipManager *target_arg);
