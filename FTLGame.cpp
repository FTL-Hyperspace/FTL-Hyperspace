...
namespace _func835
{
	...
	static FunctionDefinition funcObj("ShipManager::DamageArea", typeid(char (ShipManager::*)(Pointf , DamageParameter , char )), "578d7c240883e4f0ff77fc5589e557565389ce81ec????????8b47088b5f3cf30f105704f30f100f8945908b4710f30f118d78fffffff30f119574ffffff", argdata, 4, 1, &func);
}

__declspec(naked) char ShipManager::DamageArea(Pointf location, DamageParameter dmg, char forceHit)
{
	__asm__
	(
		"push ebp\n\t"
