...
namespace _func850
{
	static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("ShipManager::GetRandomTargettingPoint", typeid(Pointf (ShipManager::*)(bool )), "578d7c240883e4f0ff77fc5589e557565389cb83ec2c803f007465", argdata, 3, 1, &func);
}

__declspec(naked) Pointf ShipManager::GetRandomTargettingPoint(bool systemRoom)
{
	__asm__
	(
		"push ebp\n\t"
