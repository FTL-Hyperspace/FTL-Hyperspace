...
namespace _func83
{
	...
	static FunctionDefinition funcObj("Button::OnInitRect", typeid(void (Button::*)(const std::string &, const Globals::Rect &, const Globals::Rect &, bool )), "57ba????????8d7c240883e4f0ff77fc5589e557565389ce81ec????????8b07807f0c0089c1894590", argdata, 5, 5, &func);
}

__declspec(naked) void Button::OnInitRect(const std::string &img, const Globals::Rect &imageRect, const Globals::Rect &hitboxRect, bool alwaysActive)
{
	__asm__
	(
		"push ebp\n\t"
...
namespace _func172
{
	static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("CommandGui::LinkShip", typeid(void (CommandGui::*)(CompleteShip *)), "578d7c240883e4f0ff77fc5589e557565389cb81ec????????c681d419000000c681d5190000008d8d28ffffff8b37c744240400000000c70424????????e8????????8d837801000089b308170000", argdata, 2, 5, &func);
}

__declspec(naked) void CommandGui::LinkShip(CompleteShip *ship)
{
	__asm__
	(
		"push ebp\n\t"
...
namespace _func541
{
	static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("FocusWindow::constructor", typeid(void (FocusWindow::*)()), "578d7c240883e4f0ff77fc5589e5575389cb8d490883ec10c7", argdata, 1, 5, &func);
}

__declspec(naked) void FocusWindow::constructor()
{
	__asm__
	(
		"push ebp\n\t"
...
namespace _func941
{
	static void *func = 0;
	static short argdata[] = {0x101, 0x1ff};
	static FunctionDefinition funcObj("StarMap::KeyDown", typeid(bool (StarMap::*)(int )), ".80b91007000000741a5653837c240c31741e837c", argdata, 2, 1, &func);
}

__declspec(naked) bool StarMap::KeyDown(int unk0)
{
	__asm__
	(
		"push ebp\n\t"
...
namespace _func1054
{
	static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TabbedWindow::AddWindow", typeid(void (TabbedWindow::*)(const std::string &, Button *, FocusWindow *)), "578d7c240883e4f0ff77fc5589e557565389cb83ec3c8b4f088b3785c974??8b018b53188945d48b4314", argdata, 4, 5, &func);
}

__declspec(naked) void TabbedWindow::AddWindow(const std::string &name, Button *button, FocusWindow *focusWindow)
{
	__asm__
	(
		"push ebp\n\t"
