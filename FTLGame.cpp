...
namespace _func247
{
	static void *func = 0;
	static short argdata[] = {0x101, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("CrewControl::RButton", typeid(void (CrewControl::*)(int , int , bool )), "578d7c240883e4f0ff77fc5589e557565389ce83ec2c807930000f84????????8b398b461c85c074??", argdata, 4, 5, &func);
}

__declspec(naked) void CrewControl::RButton(int x, int y, bool shiftHeld)
{
	__asm__
	(
		"push ebp\n\t"
...
__declspec(naked) Slot *CrewMember::FindSlot(int roomId, int slotId, bool closeEnough)
{
	__asm__
	(
		"push ebp\n\t"
...
namespace _func461
{
	static void *func = 0;
	static short argdata[] = {0x101};
	static FunctionDefinition funcObj("Door::Manipulate", typeid(void (Door::*)()), "578d7c240883e4f0ff77fc5589e557565389cb83ec1c0fb6411883f00184c088411875??8079200074??83bbb40000000474??", argdata, 1, 5, &func);
}

__declspec(naked) void Door::Manipulate()
{
	__asm__
	(
		"push ebp\n\t"
...
__declspec(naked) int Room::GetEmptySlot(bool intruder)
{
	__asm__
	(
		"push ebp\n\t"
