...
build_one_variant build-linux-steam-1.6.13-debug amd64-linux-ftl ON Debug
build_one_variant build-linux-steam-1.6.12-debug amd64-linux-ftl OFF Debug
build_one_variant build-windows-debug x86-windows-ftl OFF Debug

build_one_variant build-linux-steam-1.6.13-release amd64-linux-ftl ON Release
build_one_variant build-linux-steam-1.6.12-release amd64-linux-ftl OFF Release
