...
| 1.11.0 | PRE_CREATE_CHOICEBOX | `LocationEvent event` | `none` | Called before the creation of a choiceBox by an event |
| 1.11.0 | POST_CREATE_CHOICEBOX | `choiceBox choiceBox`, `LocationEvent event` | `none` | Called after the creation of a choicebox by an event |
