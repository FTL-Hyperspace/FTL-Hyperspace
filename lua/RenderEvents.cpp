...
{
    LOG_HOOK("HOOK_METHOD -> CompleteShip::OnRenderShip -> Begin (RenderEvents.cpp)\n")
    auto context = Global::GetInstance()->getLuaContext();
...
{
    LOG_HOOK("HOOK_METHOD -> CrewMember::OnRenderHealth -> Begin (RenderEvents.cpp)\n")
    auto context = Global::GetInstance()->getLuaContext();
...
{
    LOG_HOOK("HOOK_METHOD -> FTLButton::OnRender -> Begin (RenderEvents.cpp)\n")
...
{
    LOG_HOOK("HOOK_METHOD_PRIORITY -> SystemBox::OnRender -> Begin (RenderEvents.cpp)\n")
    auto context = Global::GetInstance()->getLuaContext();
...
{
    LOG_HOOK("HOOK_METHOD -> ShipStatus::OnRender -> Begin (RenderEvents.cpp)\n")
...
{
    LOG_HOOK("HOOK_METHOD -> ChoiceBox::OnRender -> Begin (RenderEvents.cpp)\n")
