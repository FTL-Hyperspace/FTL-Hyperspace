...
printf "#pragma once\n#undef BUILD_IDENTIFIER_HASH\n#define BUILD_IDENTIFIER_HASH \"$version\"\n#undef BUILD_BRANCH\n#define BUILD_BRANCH \"$branch\"\n" > generated/Version.autogen.hpp.temp
# -s because the file is missing on a clean build and cmp reports that as an error
if cmp -s generated/Version.autogen.hpp generated/Version.autogen.hpp.temp; then
    rm generated/Version.autogen.hpp.temp
else
    mv -f generated/Version.autogen.hpp.temp generated/Version.autogen.hpp
fi
