...
| `FLEET <value>` | Moves the rebel fleet by the given number of jumps (negative values push it back). |
...
| Command | Description |
| --- | --- |
| `SCRAP <value>` | Adds the given amount of scrap. |
| `FUEL <value>` | Adds the given amount of fuel. |
| `MISSILES <value>` | Adds the given number of missiles. |
| `DRONES <value>` | Adds the given number of drone parts. |
| `HULL <value>` | Repairs the hull by the given number of points. |
