...
//System exclusivity
public:
    static bool AreSystemsExclusive(int sysId_1, int sysId_2);
    static void ParseExclusivityNode(rapidxml::xml_node<char>* node);
private:
    static int currentExclusivityIndex;
    static std::unordered_map<int, int> exclusivityGroups;
};
