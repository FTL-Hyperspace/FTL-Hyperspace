...
struct LIBZHL_INTERFACE CrewMember
{
	...
	LIBZHL_API virtual void OnRender(bool unk);
...
struct freetype
{
	...
	LIBZHL_API static Pointf __stdcall easy_measurePrintLines(int fontData, float x, float y, int width, std::string &text);
