...
GL_Primitive *CSurface::GL_CreateMultiImagePrimitive(GL_Texture *tex, std::vector<GL_TexVertex> *vertices, GL_Color color)
{
	typedef GL_Primitive *__attribute__((cdecl)) (*custom_arg_funcptr_t)(GL_Texture *tex_arg, std::vector<GL_TexVertex> *vertices_arg, GL_Color color_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func203::func;
	return execfunc(tex, vertices, color);
}
...
void CSurface::AddTexVertices(std::vector<GL_TexVertex> *vertices, float x, float y, float size_x, float size_y, float start_x, float end_x, float start_y, float end_y)
{
	typedef void __attribute__((cdecl)) (*custom_arg_funcptr_t)(std::vector<GL_TexVertex> *vertices_arg, float x_arg, float y_arg, float size_x_arg, float size_y_arg, float start_x_arg, float end_x_arg, float start_y_arg, float end_y_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func205::func;
	return execfunc(vertices, x, y, size_x, size_y, start_x, end_x, start_y, end_y);
}
...
GL_Primitive *ResourceControl::CreateImagePrimitive(GL_Texture *tex, int x, int y, int rotation, GL_Color color, float alpha, bool mirror)
{
	typedef GL_Primitive *__attribute__((cdecl)) (*custom_arg_funcptr_t)(ResourceControl *this_arg, GL_Texture *tex_arg, int x_arg, int y_arg, int rotation_arg, GL_Color color_arg, float alpha_arg, bool mirror_arg);
...
namespace _func1081
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("ShipManager::GetShape", typeid(Globals::Rect (ShipManager::*)()), ".5383ec188b4424248b5c24208b4004890424e8c933feff", argdata, 2, 18, &func);
}

Globals::Rect ShipManager::GetShape()
{
	typedef Globals::Rect __attribute__((cdecl)) (*custom_arg_funcptr_t)(ShipManager *this_arg);
...
namespace _func1135
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("ShipManager::GetCrewList", typeid(std::vector<CrewMember*> (ShipManager::*)()), "!5531ed575631f65383ec1c8b7c24348b5c24308b57682b5764", argdata, 2, 18, &func);
}

std::vector<CrewMember*> ShipManager::GetCrewList()
{
	typedef std::vector<CrewMember*> __attribute__((cdecl)) (*custom_arg_funcptr_t)(ShipManager *this_arg);
...
void SpaceManager::OnRenderAsteroids(int layers, float alpha)
{
	typedef void __attribute__((cdecl)) (*custom_arg_funcptr_t)(SpaceManager *this_arg, int layers_arg, float alpha_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func1250::func;
	return execfunc(this, layers, alpha);
}
...
namespace _func1381
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("SystemControl::GetSystemBox", typeid(SystemBox *(SystemControl::*)(int )), "5557565331db83ec1c8b6c24308b742434", argdata, 2, 2, &func);
}
...
namespace _func1385
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("SystemCustomBox::OnTouch", typeid(void (SystemCustomBox::*)(TouchAction , int , int , int , int , int )), ".5383ec288b4424488b5c2430894424188b442444894424148b442440894424108b44243c8944240c8b442438894424088b442434894424048d83b4010000890424", argdata, 7, 6, &func);
}

void SystemCustomBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void __attribute__((cdecl)) (*custom_arg_funcptr_t)(SystemCustomBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
namespace _func1386
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("SystemCustomBox::OnRender", typeid(void (SystemCustomBox::*)(bool )), "!.565383ec148b5c24208b7424248d83b4010000890424", argdata, 2, 6, &func);
}

void SystemCustomBox::OnRender(bool ignoreStatus)
{
	typedef void __attribute__((cdecl)) (*custom_arg_funcptr_t)(SystemCustomBox *this_arg, bool ignoreStatus_arg);
...
namespace _func1394
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TabbedWindow::GetWindow", typeid(FocusWindow *(TabbedWindow::*)(int )), ".538b4424088b4c240c8b58288b502c31c029da", argdata, 2, 2, &func);
}

FocusWindow *TabbedWindow::GetWindow(int tab)
{
	typedef FocusWindow *__attribute__((cdecl)) (*custom_arg_funcptr_t)(TabbedWindow *this_arg, int tab_arg);
...
namespace _func1395
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TabbedWindow::SetTab", typeid(void (TabbedWindow::*)(uint )), ".5557565383ec4c8b7424608d", argdata, 2, 6, &func);
}

void TabbedWindow::SetTab(uint tab)
{
	typedef void __attribute__((cdecl)) (*custom_arg_funcptr_t)(TabbedWindow *this_arg, uint tab_arg);
...
namespace _func1400
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TeleportBox::OnTouch", typeid(void (TeleportBox::*)(TouchAction , int , int , int , int , int )), ".5557565383ec3c8b5c24508b6c24608b4c24688b7c245c8b83940200008b9390020000", argdata, 7, 6, &func);
}

void TeleportBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void __attribute__((cdecl)) (*custom_arg_funcptr_t)(TeleportBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
namespace _func1401
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TeleportBox::OnRender", typeid(void (TeleportBox::*)(bool )), "!.57565383ec408b5c24500fb6442454891c2489442404", argdata, 2, 6, &func);
}

void TeleportBox::OnRender(bool ignoreStatus)
{
	typedef void __attribute__((cdecl)) (*custom_arg_funcptr_t)(TeleportBox *this_arg, bool ignoreStatus_arg);
...
namespace _func1451
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TouchTooltip::OnTouch", typeid(bool (TouchTooltip::*)(TouchAction , int , int , int , int , int )), "5383ec188b5424248b5c242083fa010f84", argdata, 7, 2, &func);
}

bool TouchTooltip::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool __attribute__((cdecl)) (*custom_arg_funcptr_t)(TouchTooltip *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
namespace _func1452
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TouchTooltip::TakeTouch", typeid(bool (TouchTooltip::*)(int , int , int , int , int )), ".8b44240480785400751c8b542408c74070000000008950648b542414", argdata, 6, 2, &func);
}

bool TouchTooltip::TakeTouch(int id, int x, int y, int initialX, int initialY)
{
	typedef bool __attribute__((cdecl)) (*custom_arg_funcptr_t)(TouchTooltip *this_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
namespace _func1455
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("TutorialManager::OnTouch", typeid(bool (TutorialManager::*)(TouchAction , int , int , int , int , int )), ".5589e557565383ec5c8b4508803800750f31c0", argdata, 7, 2, &func);
}

bool TutorialManager::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef bool __attribute__((cdecl)) (*custom_arg_funcptr_t)(TutorialManager *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
...
namespace _func1457
{
    static void *func = 0;
	static short argdata[] = {0x1ff};
	static FunctionDefinition funcObj("TutorialManager::OnRender", typeid(void (TutorialManager::*)()), ".5589e557565381ec????????8b4508803800", argdata, 1, 6, &func);
}
...
namespace _func1539
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("WeaponSystemBox::OnRender", typeid(void (WeaponSystemBox::*)(bool )), ".5589e557565383ec2c8b5d080fb6450c891c2489442404", argdata, 2, 6, &func);
}

void WeaponSystemBox::OnRender(bool ignoreStatus)
{
	typedef void __attribute__((cdecl)) (*custom_arg_funcptr_t)(WeaponSystemBox *this_arg, bool ignoreStatus_arg);
...
namespace _func1540
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("WeaponSystemBox::OnTouch", typeid(void (WeaponSystemBox::*)(TouchAction , int , int , int , int , int )), "!.5557565383ec3c8b4424548b5c24508b74245c8b6c2460894424288b442458894424248b4424648944241c8b442468894424208b03891c24", argdata, 7, 6, &func);
}

void WeaponSystemBox::OnTouch(TouchAction action, int id, int x, int y, int initialX, int initialY)
{
	typedef void __attribute__((cdecl)) (*custom_arg_funcptr_t)(WeaponSystemBox *this_arg, TouchAction action_arg, int id_arg, int x_arg, int y_arg, int initialX_arg, int initialY_arg);
