...
namespace _func665
{
	...
	static FunctionDefinition funcObj("DrawTextWithGlow", typeid(void (*)(const std::string &, Point , bool , GL_Color , float )), "5589e557565381ecac00000089????0fb6????", argdata, 5, 6, &func);
}
