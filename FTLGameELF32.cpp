...
namespace _func1255
{
    static void *func = 0;
	static short argdata[] = {0x1ff};
	static FunctionDefinition funcObj("ShipSystem::CheckDlcEnabled", typeid(void (ShipSystem::*)()), "@ _ZN10ShipSystem15CheckDlcEnabledEv ", argdata, 1, 6, &func);
}
...
namespace _func1256
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff, 0x1ff};
	static FunctionDefinition funcObj("ShipSystem::GetMannedDescription", typeid(std::string (*)(int , int )), "## ShipSystem::GetMannedDescription ->", argdata, 3, 18, &func);
}

std::string ShipSystem::GetMannedDescription(int skillId, int level)
{
	typedef std::string __attribute__((cdecl)) (*custom_arg_funcptr_t)(int skillId_arg, int level_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func1256::func;
	return execfunc(skillId, level);
}
...
{
	typedef ShipSystem::ConstComputerGlowInfo *__attribute__((cdecl)) (*custom_arg_funcptr_t)(const std::string &image_arg);
	custom_arg_funcptr_t execfunc = (custom_arg_funcptr_t) _func1257::func;
	return execfunc(image);
}
...
namespace _func1258
{
    static void *func = 0;
	static short argdata[] = {0x1ff};
	static FunctionDefinition funcObj("ShipSystem::GetExploded", typeid(bool (ShipSystem::*)()), "++ ShipSystem::GetExploded ", argdata, 1, 2, &func);
}
...
namespace _var1260
{
    static VariableDefinition varObj("symbol_lookup_test_002", "@ adapdadcmapmopqpmcqcoqemcsdpqowkpqooqpqw || !8b3d(???????\?)84d28b8580010000", &symbol_lookup_test_002);
}
