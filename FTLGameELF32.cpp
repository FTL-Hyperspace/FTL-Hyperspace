...
namespace _func264
{
	static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("CommandGui::LinkShip", typeid(void (CommandGui::*)(CompleteShip *)), ".5557565381ec0c0100008b9c24200100008d442458", argdata, 2, 6, &func);
}
...
namespace _func303
{
	static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("CompleteShip::destructor", typeid(void (CompleteShip::*)(int )), ".5383ec??8b5c24208b4308c703????????85c0", argdata, 2, 6, &func);
}
...
namespace _func861
{
	static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("ScoreKeeper::SetShipBlueprint", typeid(void (ScoreKeeper::*)(std::string *)), "8b44240405d400000089442404e9????????", argdata, 2, 6, &func);
}

void ScoreKeeper::SetShipBlueprint(std::string *blueprint)
{
	typedef void __attribute__((cdecl)) (*custom_arg_funcptr_t)(ScoreKeeper *this_arg, std::string *blueprint_arg);
...
namespace _func886
{
	static void *func = 0;
	static short argdata[] = {0x1ff};
	static FunctionDefinition funcObj("Ship::ClearImages", typeid(void (Ship::*)()), "5383ec??8b5c24208b436c", argdata, 1, 6, &func);
}
