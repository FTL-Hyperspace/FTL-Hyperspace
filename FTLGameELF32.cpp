...
namespace _func981
{
	static void *func = 0;
	static short argdata[] = {0x1ff, 0x1ff};
	static FunctionDefinition funcObj("ShipManager::SetTarget", typeid(void (ShipManager::*)(ShipManager *)), ".5557565383ec4c8b7424608b7c24648b464489bec0030000", argdata, 2, 6, &func);
}

void ShipManager::SetTarget(ShipManager *target)
{
	typedef void __attribute__((cdecl)) (*custom_arg_funcptr_t)(ShipManager *this_arg, ShipManager *target_arg);
