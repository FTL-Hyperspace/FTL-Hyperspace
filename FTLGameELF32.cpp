...
namespace _func1513
{
    static void *func = 0;
	static short argdata[] = {0x1ff, 0x2ff};
	static FunctionDefinition funcObj("TextButton::SetSize", typeid(void (TextButton::*)(Point )), ".565383ec24", argdata, 2, 6, &func);
}

void TextButton::SetSize(Point size)
{
	typedef void __attribute__((cdecl)) (*custom_arg_funcptr_t)(TextButton *this_arg, Point size_arg);
